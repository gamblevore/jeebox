...
JB_Object* JB_Dict_FindRaw(Dictionary* self, u8* key, int Length);
void JB_Dict_AddRaw(Dictionary* self, u8* key, int Length, JB_Object* Object);
...
Dictionary* JB_Nav_Dictionary(DictionaryReader* self);
...
bool JB_Nav_Exists(DictionaryReader* self);
bool JB_Nav_Active(DictionaryReader* self);
bool JB_Nav_MoveNext(DictionaryReader* self);
JB_Object* JB_Nav_NextValue(DictionaryReader* self);
bool JB_Nav_MoveAfterChildren(DictionaryReader* self);
bool JB_Nav_MoveTo(DictionaryReader* self, JB_String* name, bool GetFirst);
void JB_Nav_CopyFrom(DictionaryReader* self, DictionaryReader* ToCopy);
