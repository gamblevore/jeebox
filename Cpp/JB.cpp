...
int JB_Constants__Init_() {
	{
		...
		(JB_Dict_ValueSet(JB__Constants_EscapeStr, JB_str_176, JB_str_51));
		...
		(JB_Dict_ValueSet(JB__Constants_EscapeStr, JB_str_15, JB_str_179));
		(JB_Dict_ValueSet(JB__Constants_EscapeStr, JB_str_50, JB_str_180));
		(JB_Dict_ValueSet(JB__Constants_EscapeStr, JB_str_22, JB_str_181));
		(JB_Dict_ValueSet(JB__Constants_EscapeStr, JB_str_53, JB_str_182));
		...
		(JB_Dict_ValueSet(JB__Constants_JS_EscapeStr, JB_str_177, JB_str_178));
		(JB_Dict_ValueSet(JB__Constants_JS_EscapeStr, JB_str_15, JB_str_179));
		(JB_Dict_ValueSet(JB__Constants_JS_EscapeStr, JB_str_50, JB_str_180));
		(JB_Dict_ValueSet(JB__Constants_JS_EscapeStr, JB_str_53, JB_str_182));
		...
		JB_SetRef(JB__Constants_CSWordMiddle, JB_Str_Charset(JB_str_189, true));
		JB_SetRef(JB__Constants_CSWordStart, JB_Str_Charset(JB_str_190, true));
		JB_SetRef(JB__Constants_CSNum, JB__Constants_CSWordMiddle);
		JB_SetRef(JB__Constants_CSLine, JB_Str_Charset(JB_str_191, false));
		JB_SetRef(JB__Constants_CSAfterTemporal, JB_Str_Charset(JB_str_192, false));
		JB_SetRef(JB__Constants_CSLineBlack, JB_Str_Charset(JB_str_193, false));
		JB_SetRef(JB__Constants_CSLettersOnly, JB_Str_Charset(JB_str_194, true));
...
JB_String* JB_Constants__Test() {
	...
	JB_Decr(fs);
	if ((!(({
		JB_String* _tmp359 = JB_Incr(JB_Str_Unescape(JB_Str_Escape(str)));
		bool _tmp358 = JB_Str_SyntaxEquals(_tmp359, str, false);
		JB_Decr(_tmp359);
		_tmp358;
	})))) {
	...
	if (JB_Str_Exists(list_input)) {
		...
		({
			Message* _tmp361 = JB_Incr(JB_Msg_Copy(root, false));
			bool _tmp360 = JB_Msg_TreeCompare(root, _tmp361);
			JB_Decr(_tmp361);
			_tmp360;
		});
		Message* list = JB_Incr(({
			Message* _tmp363 = JB_Incr(JB_Str_Parse(list_input, nil));
			Message* _tmp362 = JB_Incr(JB_Msg_ParseReadable(_tmp363));
			JB_Decr(_tmp363);
			JB_SafeDecr(_tmp362);
			_tmp362;
		}));
...
void JB_Tk__ErrorEvent2(int Start, int ExpectedBits, int RealBits) {
	...
	if (RealBits == kJB__Tk_EndOfLine) {
		...
		if (((bool)(RealBits & kJB__Tk_IllegalChar))) {
			...
			JB_String* _tmp1 = JB_Incr(({
				JB_String* _tmp349 = JB_Incr(JB_Str_Range(JB__Tk_Data, Start, N));
				JB_String* _tmp348 = JB_Incr(JB_Str_Escape(_tmp349));
				JB_Decr(_tmp349);
				JB_SafeDecr(_tmp348);
				_tmp348;
			}));
	...
	({
		JB_String* _tmp351 = JB_Incr(JB_FS_SyntaxCastString(Err));
		Message* _tmp350 = JB_Incr(JB_Tk__ErrorAdd(_tmp351, Start, false));
		JB_Decr(_tmp351);
		JB_SafeDecr(_tmp350);
		_tmp350;
	});
...
Message* JB_Tk__fBinary(int Start) {
	int End = JB_Str_InStr(JB__Tk_Data, JB_str_90, Start + 2, kJB__int_max, false);
	if ((!JB_int_Found(End))) {
	...
	Message* _tmp = JB_Incr(({
		JB_String* _tmp294 = JB_Incr(JB_Str_DecodeB64(S, nil));
		Message* _tmp293 = JB_Incr(JB_Tk__NewParentName(nil, JB_SyxBin, Start, _tmp294));
		JB_Decr(_tmp294);
		JB_SafeDecr(_tmp293);
		_tmp293;
	}));
...
Message* JB_Tk__fChr(int Start) {
	...
	JB_String* name = JB_Incr(({
		JB_String* _tmp332 = JB_Incr(JB_Str_Range(JB__Tk_Data, Start + 1, After));
		JB_String* _tmp331 = JB_Incr(JB_Str_Unescape(_tmp332));
		JB_Decr(_tmp332);
		JB_SafeDecr(_tmp331);
		_tmp331;
	}));
...
void JB_Tk__Init() {
	...
	TokHan* H = JB_Incr(({
		TokHan* _tmp307 = JB_Incr(JB_TH_Link(JB_Tk__Handler(kJB__Tk_ThingWord, ((TokenHandler_fp)JB_Tk__fThingWord)), kJB__Tk_TemporalWord, ((TokenHandler_fp)JB_Tk__fTemporalStatement)));
		TokHan* _tmp306 = JB_Incr(JB_TH_Link(_tmp307, kJB__Tk_OppWord, ((TokenHandler_fp)JB_Tk__fOppWord)));
		JB_Decr(_tmp307);
		JB_SafeDecr(_tmp306);
		_tmp306;
	}));
	...
	TokHan* _tmp2 = JB_Incr(({
		TokHan* _tmp311 = JB_Incr(JB_TH_Link(JB_Tk__Handler(kJB__Tk_FuncAfterNoSpace, ((TokenHandler_fp)JB_Tk__fFuncCall)), kJB__Tk_ThingSyx, ((TokenHandler_fp)JB_Tk__fBracket)));
		TokHan* _tmp310 = JB_Incr(JB_TH_Link(_tmp311, kJB__Tk_OppBra, ((TokenHandler_fp)JB_Tk__fOppBracket)));
		JB_Decr(_tmp311);
		JB_SafeDecr(_tmp310);
		_tmp310;
	}));
	...
	TokHan* _tmp3 = JB_Incr(({
		TokHan* _tmp314 = JB_Incr(JB_Tk__Handler(kJB__Tk_FuncAfterNoSpace, ((TokenHandler_fp)JB_Tk__fAccess)));
		TokHan* _tmp313 = JB_Incr(JB_TH_Link(_tmp314, kJB__Tk_ThingSyx, ((TokenHandler_fp)JB_Tk__fArray)));
		JB_Decr(_tmp314);
		JB_SafeDecr(_tmp313);
		_tmp313;
	}));
	...
	TokHan* _tmp4 = JB_Incr(({
		TokHan* _tmp317 = JB_Incr(JB_Tk__Handler(kJB__Tk_FuncAfterNoSpace, ((TokenHandler_fp)JB_Tk__fDot)));
		TokHan* _tmp316 = JB_Incr(JB_TH_Link(_tmp317, kJB__Tk_ThingSyx, ((TokenHandler_fp)JB_Tk__fSDot)));
		JB_Decr(_tmp317);
		JB_SafeDecr(_tmp316);
		_tmp316;
	}));
	...
	TokHan* _tmp5 = JB_Incr(({
		TokHan* _tmp320 = JB_Incr(JB_Tk__Handler(kJB__Tk_FuncAfterBar, ((TokenHandler_fp)JB_Tk__fBarTypeCast)));
		TokHan* _tmp319 = JB_Incr(JB_TH_Link(_tmp320, kJB__Tk_TemporalSyx, ((TokenHandler_fp)JB_Tk__fDecl)));
		JB_Decr(_tmp320);
		JB_SafeDecr(_tmp319);
		_tmp319;
	}));
	...
	TokHan* _tmp6 = JB_Incr(({
		TokHan* _tmp323 = JB_Incr(JB_Tk__Handler(kJB__Tk_ThingSyx, ((TokenHandler_fp)JB_Tk__fAtName)));
		TokHan* _tmp322 = JB_Incr(JB_TH_Link(_tmp323, kJB__Tk_FuncAfterNormal, ((TokenHandler_fp)JB_Tk__fAtNamedExp)));
		JB_Decr(_tmp323);
		JB_SafeDecr(_tmp322);
		_tmp322;
	}));
	...
	TokHan* _tmp7 = JB_Incr(({
		TokHan* _tmp326 = JB_Incr(JB_Tk__Handler(kJB__Tk_FuncAfterNormal, ((TokenHandler_fp)JB_Tk__fAdjectiveThing)));
		TokHan* _tmp325 = JB_Incr(JB_TH_Link(_tmp326, kJB__Tk_adjectiveop, ((TokenHandler_fp)JB_Tk__fAdjectiveOp)));
		JB_Decr(_tmp326);
		JB_SafeDecr(_tmp325);
		_tmp325;
	}));
...
int JB_Tk__MessageErrorSub(FastString* fs, int num, int ButFound) {
	...
	if (BestValue) {
		JB_String* _tmp = JB_Incr(({
			JB_String* _tmp354 = JB_Incr(JB_int_DictName(BestValue));
			JB_String* _tmp353 = JB_Incr(((JB_String*)JB_Dict_Value(JB__Tk_ErrorNames, _tmp354)));
			JB_Decr(_tmp354);
			JB_SafeDecr(_tmp353);
			_tmp353;
		}));
...
bool JB_Platform__linux() {
	return (({
		JB_String* _tmp217 = JB_Incr(JB_Platform());
		bool _tmp216 = JB_Str_SyntaxEquals(_tmp217, JB_str_33, false);
		JB_Decr(_tmp217);
		_tmp216;
	}));
}
...
void JB_BinaryEscapeTest(JB_String* AllBytes) {
	...
	JB_String* a = JB_Incr(JB_str_44);
	{
		...
		while (_i1 < 10) {
			...
			JB_Decr(b);
			JB_SetRef(a, ({
				JB_String* _tmp230 = JB_Incr(JB_Str_OperatorPlus(JB_str_47, a));
				JB_String* _tmp229 = JB_Incr(JB_Str_OperatorPlus(a, _tmp230));
				JB_Decr(_tmp230);
				JB_SafeDecr(_tmp229);
				_tmp229;
			}));
...
bool JB_CompareError(Message* expected, Message* found) {
	...
	JB_String* _tmp5 = JB_Incr(({
		Message* _tmp266 = JB_Incr(JB_Msg_PoorAnt(expected));
		JB_String* _tmp265 = JB_Incr(JB_Msg_Locate(_tmp266));
		JB_Decr(_tmp266);
		JB_SafeDecr(_tmp265);
		_tmp265;
	}));
	...
	if (found) {
		...
		JB_String* _tmp6 = JB_Incr(({
			Message* _tmp269 = JB_Incr(JB_Msg_PoorAnt(found));
...
JB_String* JB_EntityTest() {
	...
	JB_String* result = JB_Incr(({
		JB_String* _tmp271 = JB_Incr(JB_Str_LowerCase(replicate));
		JB_String* _tmp270 = JB_Incr(JB_Str_OperatorPlus(_tmp271, JB_str_79));
		JB_Decr(_tmp271);
		JB_SafeDecr(_tmp270);
		_tmp270;
	}));
...
int JB_Init_() {
	{
		JB_SetRef(JB_str_264, JB_Str3("Binary", 6));
		JB_SetRef(JB_str_263, JB_Str3("bin", 3));
		JB_SetRef(JB_str_262, JB_Str3("\n{\n\t\"glossary\": {\n\t\t\"title\": \"example glossary\",\n\t\t\"GlossDiv\": {\n\t\t\t\"title\": \"S\",\n\t\t\t\"GlossList\": {\n\t\t\t\t\"GlossEntry\": {\n\t\t\t\t\t\"ID\": \"SGML\",\n\t\t\t\t\t\"SortAs\": \"SGML\",\n\t\t\t\t\t\"GlossTerm\": \"Standard \\\\Generalized Markup Language\",\n\t\t\t\t\t\"Acronym\": \"SGML\",\n\t\t\t\t\t\"Abbrev\": \"ISO 8879:1986\",\n\t\t\t\t\t\"GlossDef\": {\n\t\t\t\t\t\t\"para\": \"A meta-markup language, \\nused to create markup languages such as \\\"DocBook\\\".\",\n\t\t\t\t\t\t\"GlossSeeAlso\": [\"GML\", \"XML\"]\n\t\t\t\t\t},\n\t\t\t\t\t\"GlossSee\": \"markup\"\n\t\t\t\t}\n\t\t\t}\n\t\t}\n\t}\n}\n", 484));
		JB_SetRef(JB_str_261, JB_Str3("Typecast", 8));
		JB_SetRef(JB_str_260, JB_Str3("type", 4));
		JB_SetRef(JB_str_259, JB_Str3("Conjugate", 9));
		JB_SetRef(JB_str_258, JB_Str3("cnj", 3));
		JB_SetRef(JB_str_257, JB_Str3("Syntactic_Conjugate", 19));
		JB_SetRef(JB_str_256, JB_Str3("scnj", 4));
		JB_SetRef(JB_str_255, JB_Str3("Temporal_Reference", 18));
		JB_SetRef(JB_str_254, JB_Str3("ana", 3));
		JB_SetRef(JB_str_253, JB_Str3("Temporal_Statement", 18));
		JB_SetRef(JB_str_252, JB_Str3("tmp", 3));
		JB_SetRef(JB_str_251, JB_Str3("Thing", 5));
		JB_SetRef(JB_str_250, JB_Str3("thg", 3));
		JB_SetRef(JB_str_249, JB_Str3("Syntactic_Thing", 15));
		JB_SetRef(JB_str_248, JB_Str3("sthg", 4));
		JB_SetRef(JB_str_247, JB_Str3("String", 6));
		JB_SetRef(JB_str_246, JB_Str3("str", 3));
		JB_SetRef(JB_str_245, JB_Str3("Shebang", 7));
		JB_SetRef(JB_str_244, JB_Str3("sheb", 4));
		JB_SetRef(JB_str_243, JB_Str3("Syntactic_Comment", 17));
		JB_SetRef(JB_str_242, JB_Str3("scom", 4));
		JB_SetRef(JB_str_241, JB_Str3("Self_Dot", 8));
		JB_SetRef(JB_str_240, JB_Str3("sdot", 4));
		JB_SetRef(JB_str_239, JB_Str3("Temporal_Relationship", 21));
		JB_SetRef(JB_str_238, JB_Str3("trel", 4));
		JB_SetRef(JB_str_237, JB_Str3("Relationship", 12));
		JB_SetRef(JB_str_236, JB_Str3("rel", 3));
		JB_SetRef(JB_str_235, JB_Str3("Syntactic_Operator", 18));
		JB_SetRef(JB_str_234, JB_Str3("sopp", 4));
		JB_SetRef(JB_str_233, JB_Str3("Operator", 8));
		JB_SetRef(JB_str_232, JB_Str3("opp", 3));
		JB_SetRef(JB_str_231, JB_Str3("Operator_As_Thing", 17));
		JB_SetRef(JB_str_230, JB_Str3("oat", 3));
		JB_SetRef(JB_str_229, JB_Str3("unit", 4));
		JB_SetRef(JB_str_228, JB_Str3("Number", 6));
		JB_SetRef(JB_str_227, JB_Str3("num", 3));
		JB_SetRef(JB_str_226, JB_Str3("name", 4));
		JB_SetRef(JB_str_225, JB_Str3("item", 4));
		JB_SetRef(JB_str_224, JB_Str3("Function", 8));
		JB_SetRef(JB_str_223, JB_Str3("func", 4));
		JB_SetRef(JB_str_222, JB_Str3("Equals_Relationship", 19));
		JB_SetRef(JB_str_221, JB_Str3("erel", 4));
		JB_SetRef(JB_str_220, JB_Str3("Embedded_Value", 14));
		JB_SetRef(JB_str_219, JB_Str3("emb", 3));
		JB_SetRef(JB_str_218, JB_Str3("Dot", 3));
		JB_SetRef(JB_str_217, JB_Str3("dot", 3));
		JB_SetRef(JB_str_216, JB_Str3("Declaration", 11));
		JB_SetRef(JB_str_215, JB_Str3("decl", 4));
		JB_SetRef(JB_str_214, JB_Str3("Character", 9));
		JB_SetRef(JB_str_213, JB_Str3("char", 4));
		JB_SetRef(JB_str_212, JB_Str3("Before_Relationship", 19));
		JB_SetRef(JB_str_211, JB_Str3("brel", 4));
		JB_SetRef(JB_str_210, JB_Str3("Bracket", 7));
		JB_SetRef(JB_str_209, JB_Str3("bra", 3));
		JB_SetRef(JB_str_208, JB_Str3("Super_String", 12));
		JB_SetRef(JB_str_207, JB_Str3("sstr", 4));
		JB_SetRef(JB_str_206, JB_Str3("Backtick", 8));
		JB_SetRef(JB_str_205, JB_Str3("back", 4));
		JB_SetRef(JB_str_204, JB_Str3("Array", 5));
		JB_SetRef(JB_str_203, JB_Str3("arr", 3));
		JB_SetRef(JB_str_202, JB_Str3("After_Relationship", 18));
		JB_SetRef(JB_str_201, JB_Str3("arel", 4));
		JB_SetRef(JB_str_200, JB_Str3("Adjective", 9));
		JB_SetRef(JB_str_199, JB_Str3("adj", 3));
		JB_SetRef(JB_str_198, JB_Str3("Access", 6));
		JB_SetRef(JB_str_197, JB_Str3("acc", 3));
		JB_SetRef(JB_str_196, JB_Str3("Argument", 8));
		JB_SetRef(JB_str_195, JB_Str3("arg", 3));
		JB_SetRef(JB_str_194, JB_Str3("AZazÄø¬Ù", 8));
		JB_SetRef(JB_str_193, JB_Str3("\n\r,", 3));
		JB_SetRef(JB_str_192, JB_Str3(" ,:\t\n\r\\", 7));
		JB_SetRef(JB_str_191, JB_Str3("\n\r", 2));
		JB_SetRef(JB_str_190, JB_Str3("AZaz__Äø¬Ù", 10));
		JB_SetRef(JB_str_189, JB_Str3("AZaz09__Äø¬Ù", 12));
		...
		JB_SetRef(JB_str_178, JB_Str3("\\r", 2));
		JB_SetRef(JB_str_177, JB_Str3("\r", 1));
		JB_SetRef(JB_str_176, JB_Str3("\0", 1));
		JB_SetRef(JB_str_175, JB_Str3("[0;1;33m", 9));
		JB_SetRef(JB_str_174, JB_Str3("[0;1;32m", 9));
		JB_SetRef(JB_str_173, JB_Str3("[0;1;31m", 9));
		JB_SetRef(JB_str_172, JB_Str3("[0;1m", 6));
		JB_SetRef(JB_str_171, JB_Str3("[0m", 4));
		JB_SetRef(JB_str_170, JB_Str3("@JBSave\n", 8));
		...
		JB_SetRef(JB_SyxArg, JB_Fn__StdNew(JB_Msg_Arg__, 0, JB_str_195, JB_str_196));
		JB_SetRef(JB_SyxAcc, JB_Fn__StdNew(JB_Msg_Acc__, 1, JB_str_197, JB_str_198));
		JB_SetRef(JB_SyxAdj, JB_Fn__StdNew(JB_Msg_Adj__, 2, JB_str_199, JB_str_200));
		JB_SetRef(JB_SyxARel, JB_Fn__StdNew(JB_Msg_ARel__, 3, JB_str_201, JB_str_202));
		JB_SetRef(JB_SyxArr, JB_Fn__StdNew(JB_Msg_Arr__, 4, JB_str_203, JB_str_204));
		JB_SetRef(JB_SyxBack, JB_Fn__StdNew(JB_Msg_Back__, 5, JB_str_205, JB_str_206));
		JB_SetRef(JB_SyxSStr, JB_Fn__StdNew(JB_Msg_SStr__, 6, JB_str_207, JB_str_208));
		JB_SetRef(JB_SyxBra, JB_Fn__StdNew(JB_Msg_Bra__, 7, JB_str_209, JB_str_210));
		JB_SetRef(JB_SyxBRel, JB_Fn__StdNew(JB_Msg_BRel__, 8, JB_str_211, JB_str_212));
		JB_SetRef(JB_SyxChar, JB_Fn__StdNew(JB_Msg_Char__, 9, JB_str_213, JB_str_214));
		JB_SetRef(JB_SyxDecl, JB_Fn__StdNew(JB_Msg_Decl__, 10, JB_str_215, JB_str_216));
		JB_SetRef(JB_SyxDot, JB_Fn__StdNew(JB_Msg_Dot__, 11, JB_str_217, JB_str_218));
		JB_SetRef(JB_SyxEmb, JB_Fn__StdNew(JB_Msg_Emb__, 12, JB_str_219, JB_str_220));
		JB_SetRef(JB_SyxERel, JB_Fn__StdNew(JB_Msg_ERel__, 13, JB_str_221, JB_str_222));
		JB_SetRef(JB_SyxFunc, JB_Fn__StdNew(JB_Msg_Func__, 14, JB_str_223, JB_str_224));
		JB_SetRef(JB_SyxItem, JB_Fn__StdNew(JB_Msg_Item__, 15, JB_str_225, JB_str_0));
		JB_SetRef(JB_SyxList, JB_Fn__StdNew(JB_Msg_List__, 16, JB_str_160, JB_str_0));
		JB_SetRef(JB_SyxName, JB_Fn__StdNew(JB_Msg_Name__, 17, JB_str_226, JB_str_0));
		JB_SetRef(JB_SyxNum, JB_Fn__StdNew(JB_Msg_Num__, 18, JB_str_227, JB_str_228));
		JB_SetRef(JB_SyxUnit, JB_Fn__StdNew(JB_Msg_Unit__, 19, JB_str_229, JB_str_0));
		JB_SetRef(JB_SyxOat, JB_Fn__StdNew(JB_Msg_Oat__, 20, JB_str_230, JB_str_231));
		JB_SetRef(JB_SyxOpp, JB_Fn__StdNew(JB_Msg_Opp__, 21, JB_str_232, JB_str_233));
		JB_SetRef(JB_SyxSOpp, JB_Fn__StdNew(JB_Msg_SOpp__, 22, JB_str_234, JB_str_235));
		JB_SetRef(JB_SyxRel, JB_Fn__StdNew(JB_Msg_Rel__, 23, JB_str_236, JB_str_237));
		JB_SetRef(JB_SyxTRel, JB_Fn__StdNew(JB_Msg_TRel__, 24, JB_str_238, JB_str_239));
		JB_SetRef(JB_SyxSDot, JB_Fn__StdNew(JB_Msg_SDot__, 25, JB_str_240, JB_str_241));
		JB_SetRef(JB_SyxSCom, JB_Fn__StdNew(JB_Msg_SCom__, 26, JB_str_242, JB_str_243));
		JB_SetRef(JB_SyxSheb, JB_Fn__StdNew(JB_Msg_Sheb__, 27, JB_str_244, JB_str_245));
		JB_SetRef(JB_SyxStr, JB_Fn__StdNew(JB_Msg_Str__, 28, JB_str_246, JB_str_247));
		JB_SetRef(JB_SyxSThg, JB_Fn__StdNew(JB_Msg_SThg__, 29, JB_str_248, JB_str_249));
		JB_SetRef(JB_SyxThg, JB_Fn__StdNew(JB_Msg_Thg__, 30, JB_str_250, JB_str_251));
		JB_SetRef(JB_SyxTmp, JB_Fn__StdNew(JB_Msg_Tmp__, 31, JB_str_252, JB_str_253));
		JB_SetRef(JB_SyxAna, JB_Fn__StdNew(JB_Msg_Ana__, 32, JB_str_254, JB_str_255));
		JB_SetRef(JB_SyxSCnj, JB_Fn__StdNew(JB_Msg_SCnj__, 33, JB_str_256, JB_str_257));
		JB_SetRef(JB_SyxCnj, JB_Fn__StdNew(JB_Msg_Cnj__, 34, JB_str_258, JB_str_259));
		JB_SetRef(JB_SyxType, JB_Fn__StdNew(JB_Msg_Type__, 35, JB_str_260, JB_str_261));
		JB_SetRef(JB_JSONTest, JB_str_262);
		JB_SetRef(JB_SyxBin, JB_Fn__StdNew(JB_Msg_Bin__, 36, JB_str_263, JB_str_264));
	};
	//// JB_API;
	JB_API__Init_();
	//// Jeebox;
...
Message* JB_Str_ParseAs(JB_String* self, JB_String* name) {
	if ((!JB_Str_Exists(name)) or (JB_Str_SyntaxEquals(name, JB_str_159, true))) {
		...
		return ({
			Message* _tmp357 = JB_Incr(JB_Str_Parse(self, nil));
			Message* _tmp356 = JB_Incr(JB_Msg_ParseReadable(_tmp357));
			JB_Decr(_tmp357);
			JB_SafeDecr(_tmp356);
			_tmp356;
		});
...
JB_Object* JB_Dict_Syntax(Dictionary* self, JB_String* Key) {
	return ({
		JB_String* _tmp299 = JB_Incr(JB_Str_FastLower(Key));
		JB_Object* _tmp298 = JB_Incr(JB_Dict_Value(self, _tmp299));
		JB_Decr(_tmp299);
		JB_SafeDecr(_tmp298);
		_tmp298;
	});
...
Message* JB_Msg_Copy(Message* self, bool DefaultLayer) {
	if (DefaultLayer) {
		...
		return ({
			JB_MemoryLayer* _tmp237 = JB_Incr(JB_ObjLayer(self));
			Message* _tmp236 = JB_Incr(JB_Msg_LayerCopy(self, _tmp237));
			JB_Decr(_tmp237);
			JB_SafeDecr(_tmp236);
			_tmp236;
		});
...
Message* JB_Msg_LoadNameFromList(Message* self, Message* line) {
	...
	JB_Decr(_tmp);
	JB_SetRef(self->Name, ({
		Message* _tmp254 = JB_Incr(((Message*)JB_Ring_NextSib(func)));
		JB_String* _tmp253 = JB_Incr(JB_Msg_Nyme(_tmp254));
		JB_Decr(_tmp254);
		JB_SafeDecr(_tmp253);
		_tmp253;
	}));
