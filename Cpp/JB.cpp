...
int JB_Constants__Init_() {
	{
		...
		JB_SetRef(JB__Constants_CSWordMiddle, JB_Str_Charset(JB_str_242, true));
		JB_SetRef(JB__Constants_CSWordStart, JB_Str_Charset(JB_str_243, true));
		JB_SetRef(JB__Constants_CSNum, JB__Constants_CSWordMiddle);
		JB_SetRef(JB__Constants_CSLine, JB_Str_Charset(JB_str_244, false));
		JB_SetRef(JB__Constants_CSAfterTemporal, JB_Str_Charset(JB_str_245, false));
		JB_SetRef(JB__Constants_CSLineBlack, JB_Str_Charset(JB_str_246, false));
		JB_SetRef(JB__Constants_CSLettersOnly, JB_Str_Charset(JB_str_247, true));
...
JB_String* JB_Constants__Test() {
	...
	JB_Decr(fs);
	if ((!(({
		JB_String* _tmP399 = JB_Incr(({
			JB_String* _tmP401 = JB_Incr(JB_Str_Escape(str));
			JB_String* _tmP400 = JB_Incr(JB_Str_Unescape(_tmP401));
			JB_Decr(_tmP401);
			JB_SafeDecr(_tmP400);
			 _tmP400;
		}));
		bool _tmP398 = JB_Str_SyntaxEquals(_tmP399, str, false);
		JB_Decr(_tmP399);
		 _tmP398;
	})))) {
	...
	if (JB_Str_Exists(list_input)) {
		...
		Message* list = JB_Incr(({
			Message* _tmP403 = JB_Incr(JB_Str_Parse(list_input, nil));
			Message* _tmP402 = JB_Incr(JB_Msg_ParseAST(_tmP403));
			JB_Decr(_tmP403);
			JB_SafeDecr(_tmP402);
			 _tmP402;
		}));
...
Message* JB_Tk__BarThings(int Start, Syntax Syx) {
	...
	JB__Tk_StopBars = 0;
	if ((!JB_Tk__ExpectEndChar(JB_str_110, true))) {
		JB_Decr(item);
		return nil;
	}
...
Message* JB_Tk__DotSub(Syntax fn, int Start) {
	...
	if (JB_Tk__EatString(JB_str_108)) {
...
void JB_Tk__ErrorEvent2(int Start, int ExpectedBits, int RealBits) {
	...
	if (RealBits == kJB__Tk_EndOfLine) {
		...
		if (((bool)(RealBits & kJB__Tk_IllegalChar))) {
			...
			JB_String* _tmP1 = JB_Incr(({
				JB_String* _tmP391 = JB_Incr(JB_Str_Range(JB__Tk_Data, Start, N));
				JB_String* _tmP390 = JB_Incr(JB_Str_Escape(_tmP391));
				JB_Decr(_tmP391);
				JB_SafeDecr(_tmP390);
				 _tmP390;
			}));
	...
	JB_FreeIfDead(({
		JB_String* _tmP393 = JB_Incr(JB_FS_SyntaxCastString(Err));
		Message* _tmP392 = JB_Incr(JB_Tk__ErrorAdd(_tmP393, Start));
		JB_Decr(_tmP393);
		JB_SafeDecr(_tmP392);
		 _tmP392;
	}));
...
Message* JB_Tk__fBackTick(int Start) {
	return JB_Tk__fStrSub(Start, JB_str_123, JB_SyxBack);
}
...
Message* JB_Tk__fBinary(int Start) {
	...
	Message* _tmP = JB_Incr(({
		JB_String* _tmP319 = JB_Incr(JB_Str_DecodeB64(S, nil));
		Message* _tmP318 = JB_Incr(JB_Tk__NewParentName(nil, JB_SyxBin, Start, _tmP319));
		JB_Decr(_tmP319);
		JB_SafeDecr(_tmP318);
		 _tmP318;
	}));
...
Message* JB_Tk__fChr(int Start) {
	...
	JB_String* name = JB_Incr(({
		JB_String* _tmP373 = JB_Incr(JB_Str_Range(JB__Tk_Data, Start + 1, After));
		JB_String* _tmP372 = JB_Incr(JB_Str_Unescape(_tmP373));
		JB_Decr(_tmP373);
		JB_SafeDecr(_tmP372);
		 _tmP372;
	}));
...
Message* JB_Tk__fSyntacticComment(int Start) {
	...
	JB_Tk__EmbeddedArg(JB_str_139, Result, JB_SyxList);
	JB_SafeDecr(Result);
	return Result;
}
...
void JB_Tk__Init() {
	JB_String* lines = JB_Incr(JB_str_103);
	...
	JB_Decr(lines);
	Array* numb = JB_Incr(JB_Str_ByteSplit(JB_str_104));
	JB_String* op_comp = JB_Incr(JB_str_105);
	JB_String* op_math = JB_Incr(JB_str_106);
	JB_String* PFix = JB_Incr(JB_str_107);
	TokHan* H = JB_Incr(({
		TokHan* _tmP342 = JB_Incr(({
			TokHan* _tmP344 = JB_Incr(JB_Tk__Handler(kJB__Tk_ThingWord, ((TokenHandler_fp)JB_Tk__fThingWord)));
			TokHan* _tmP343 = JB_Incr(JB_TH_Link(_tmP344, kJB__Tk_TemporalWord, ((TokenHandler_fp)JB_Tk__fTemporalStatement)));
			JB_Decr(_tmP344);
			JB_SafeDecr(_tmP343);
			 _tmP343;
		}));
		TokHan* _tmP341 = JB_Incr(JB_TH_Link(_tmP342, kJB__Tk_OppWord, ((TokenHandler_fp)JB_Tk__fOppWord)));
		JB_Decr(_tmP342);
		JB_SafeDecr(_tmP341);
		 _tmP341;
	}));
	...
	TokHan* _tmP2 = JB_Incr(({
		TokHan* _tmP348 = JB_Incr(({
			TokHan* _tmP350 = JB_Incr(JB_Tk__Handler(kJB__Tk_FuncAfterNoSpace, ((TokenHandler_fp)JB_Tk__fFuncCall)));
			TokHan* _tmP349 = JB_Incr(JB_TH_Link(_tmP350, kJB__Tk_ThingSyx, ((TokenHandler_fp)JB_Tk__fBracket)));
			JB_Decr(_tmP350);
			JB_SafeDecr(_tmP349);
			 _tmP349;
		}));
		TokHan* _tmP347 = JB_Incr(JB_TH_Link(_tmP348, kJB__Tk_OppBra, ((TokenHandler_fp)JB_Tk__fOppBracket)));
		JB_Decr(_tmP348);
		JB_SafeDecr(_tmP347);
		 _tmP347;
	}));
	...
	TokHan* _tmP3 = JB_Incr(({
		TokHan* _tmP353 = JB_Incr(JB_Tk__Handler(kJB__Tk_FuncAfterNoSpace, ((TokenHandler_fp)JB_Tk__fAccess)));
		TokHan* _tmP352 = JB_Incr(JB_TH_Link(_tmP353, kJB__Tk_ThingSyx, ((TokenHandler_fp)JB_Tk__fArray)));
		JB_Decr(_tmP353);
		JB_SafeDecr(_tmP352);
		 _tmP352;
	}));
	(JB_Tk__TokenSet(JB_str_109, _tmP3));
	JB_Decr(_tmP3);
	...
	TokHan* _tmP5 = JB_Incr(({
		TokHan* _tmP357 = JB_Incr(JB_Tk__Handler(kJB__Tk_FuncAfterNoSpace, ((TokenHandler_fp)JB_Tk__fDot)));
		TokHan* _tmP356 = JB_Incr(JB_TH_Link(_tmP357, kJB__Tk_ThingSyx, ((TokenHandler_fp)JB_Tk__fSDot)));
		JB_Decr(_tmP357);
		JB_SafeDecr(_tmP356);
		 _tmP356;
	}));
	...
	TokHan* _tmP6 = JB_Incr(({
		TokHan* _tmP360 = JB_Incr(JB_Tk__Handler(kJB__Tk_FuncAfterBar, ((TokenHandler_fp)JB_Tk__fBarTypeCast)));
		TokHan* _tmP359 = JB_Incr(JB_TH_Link(_tmP360, kJB__Tk_TemporalSyx, ((TokenHandler_fp)JB_Tk__fDecl)));
		JB_Decr(_tmP360);
		JB_SafeDecr(_tmP359);
		 _tmP359;
	}));
	(JB_Tk__TokenSet(JB_str_110, _tmP6));
	JB_Decr(_tmP6);
	TokHan* _tmP7 = JB_Incr(({
		TokHan* _tmP363 = JB_Incr(JB_Tk__Handler(kJB__Tk_ThingSyx, ((TokenHandler_fp)JB_Tk__fAtName)));
		TokHan* _tmP362 = JB_Incr(JB_TH_Link(_tmP363, kJB__Tk_FuncAfterNormal, ((TokenHandler_fp)JB_Tk__fAtNamedExp)));
		JB_Decr(_tmP363);
		JB_SafeDecr(_tmP362);
		 _tmP362;
	}));
	(JB_Tk__TokenSet(JB_str_111, _tmP7));
	JB_Decr(_tmP7);
	TokHan* _tmP8 = JB_Incr(({
		TokHan* _tmP366 = JB_Incr(JB_Tk__Handler(kJB__Tk_FuncAfterNormal, ((TokenHandler_fp)JB_Tk__fAdjectiveThing)));
		TokHan* _tmP365 = JB_Incr(JB_TH_Link(_tmP366, kJB__Tk_adjectiveop, ((TokenHandler_fp)JB_Tk__fAdjectiveOp)));
		JB_Decr(_tmP366);
		JB_SafeDecr(_tmP365);
		 _tmP365;
	}));
	...
	JB_Decr(_tmP8);
	JB_Tk__Tokenz(JB_str_113, kJB__Tk_ThingSyx, JB_Tk__fBeforeRelMinus);
	JB_Tk__Tokenz(PFix, kJB__Tk_ThingSyx, JB_Tk__fBeforeRel);
	JB_Tk__Tokenz(PFix, kJB__Tk_FuncAfterNormal, JB_Tk__fAfterRel);
	JB_Decr(PFix);
	JB_Tk__Tokenz(JB_str_114, kJB__Tk_colon, JB_Tk__fEndOfLine);
	JB_Tk__Tokenz(JB_str_68, kJB__Tk_ThingSyx, JB_Tk__fTemporalAsThing);
	JB_Tk__Tokenz(JB_str_115, kJB__Tk_ThingSyx, JB_Tk__fArgOpen);
	JB_Tk__Tokenz(JB_str_116, kJB__Tk_TmpOpp, JB_Tk__fTemporalRel);
	JB_Tk__Tokenz(JB_str_117, kJB__Tk_TmpOpp, JB_Tk__fTemporalRelSyx);
	...
	JB_Tk__Tokenz(JB_str_118, kJB__Tk_EndOfLine, JB_Tk__fCommentLine);
	JB_Tk__Tokenz(JB_str_119, kJB__Tk_EndOfLine, JB_Tk__fComment);
	...
	JB_Tk__Tokenz(JB_str_121, kJB__Tk_ThingSyx, JB_Tk__fBunchOfThings);
	JB_Tk__Tokenz(JB_str_122, kJB__Tk_ThingSyx, JB_Tk__fThingSyx);
	JB_Tk__Tokenz(JB_str_51, kJB__Tk_ThingSyx, JB_Tk__fString2);
	JB_Tk__Tokenz(JB_str_22, kJB__Tk_ThingSyx, JB_Tk__fChr);
	JB_Tk__Tokenz(JB_str_123, kJB__Tk_ThingSyx, JB_Tk__fBackTick);
	JB_Tk__Tokenz(JB_str_62, kJB__Tk_ThingSyx, JB_Tk__fSuperStr);
	JB_Tk__Tokenz(JB_str_124, kJB__Tk_ThingSyx, JB_Tk__fBeforeRel);
	JB_Tk__Tokenz(JB_str_125, kJB__Tk_SyntacticComment, JB_Tk__fSyntacticComment);
	JB_Tk__Tokenz(JB_str_94, kJB__Tk_ThingSyx, JB_Tk__fBinary);
	JB_Tk__Tokenz(JB_str_126, kJB__Tk_EndContainer, JB_Tk__fEndOfLine);
...
int JB_Tk__MessageErrorSub(FastString* fs, int num, int ButFound) {
	if ((!JB__Tk_ErrorNames)) {
		...
		(JB_Dict_a4(JB__Tk_ErrorNames, kJB__Tk_Temporal, JB_str_152));
		(JB_Dict_a4(JB__Tk_ErrorNames, kJB__Tk_TemporalSyx, JB_str_153));
		(JB_Dict_a4(JB__Tk_ErrorNames, kJB__Tk_TemporalWord, JB_str_154));
		(JB_Dict_a4(JB__Tk_ErrorNames, kJB__Tk_SyntacticComment, JB_str_149));
		(JB_Dict_a4(JB__Tk_ErrorNames, kJB__Tk_EndOfLine, JB_str_148));
		(JB_Dict_a4(JB__Tk_ErrorNames, kJB__Tk_colon, JB_str_155));
		(JB_Dict_a4(JB__Tk_ErrorNames, kJB__Tk_OppSyx, JB_str_156));
		(JB_Dict_a4(JB__Tk_ErrorNames, kJB__Tk_OppWord, JB_str_156));
		(JB_Dict_a4(JB__Tk_ErrorNames, kJB__Tk_Opp, JB_str_156));
		(JB_Dict_a4(JB__Tk_ErrorNames, kJB__Tk_OppTemporal, JB_str_157));
		(JB_Dict_a4(JB__Tk_ErrorNames, kJB__Tk_FuncAfterBar, JB_str_158));
		(JB_Dict_a4(JB__Tk_ErrorNames, kJB__Tk_Thing, JB_str_159));
		(JB_Dict_a4(JB__Tk_ErrorNames, kJB__Tk_ThingWord, JB_str_159));
		(JB_Dict_a4(JB__Tk_ErrorNames, kJB__Tk_ThingSyx, JB_str_160));
		(JB_Dict_a4(JB__Tk_ErrorNames, kJB__Tk_IllegalChar, JB_str_161));
	}
	if (JB_FS_Length(fs)) {
...
void JB_BinaryEscapeTest(JB_String* AllBytes) {
	...
	JB_String* a = JB_Incr(JB_str_45);
	{
		...
		while (_i1 < 10) {
			...
			JB_Decr(b);
			JB_SetRef(a, ({
				JB_String* _tmP238 = JB_Incr(JB_Str_OperatorPlus(JB_str_48, a));
				JB_String* _tmP237 = JB_Incr(JB_Str_OperatorPlus(a, _tmP238));
				JB_Decr(_tmP238);
				JB_SafeDecr(_tmP237);
				 _tmP237;
			}));
...
bool JB_CompareError(Message* expected, Message* found) {
	...
	JB_String* _tmP5 = JB_Incr(({
		Message* _tmP291 = JB_Incr(JB_Msg_PoorAnt(expected));
		JB_String* _tmP290 = JB_Incr(JB_Msg_Locate(_tmP291));
		JB_Decr(_tmP291);
		JB_SafeDecr(_tmP290);
		 _tmP290;
	}));
	...
	if (found) {
		...
		JB_String* _tmP6 = JB_Incr(({
			Message* _tmP294 = JB_Incr(JB_Msg_PoorAnt(found));
			JB_String* _tmP293 = JB_Incr(JB_Msg_Locate(_tmP294));
			JB_Decr(_tmP294);
			JB_SafeDecr(_tmP293);
			 _tmP293;
		}));
...
JB_String* JB_EntityTest() {
	...
	JB_String* result = JB_Incr(({
		JB_String* _tmP296 = JB_Incr(JB_Str_LowerCase(replicate));
		JB_String* _tmP295 = JB_Incr(JB_Str_OperatorPlus(_tmP296, JB_str_83));
		JB_Decr(_tmP296);
		JB_SafeDecr(_tmP295);
		 _tmP295;
	}));
...
int JB_Init_() {
	{
		...
		JB_SetRef(JB_str_247, JB_Str3("AZaz����", 8));
		JB_SetRef(JB_str_246, JB_Str3("\n\r,", 3));
		JB_SetRef(JB_str_245, JB_Str3(" ,:\t\n\r\\", 7));
		JB_SetRef(JB_str_244, JB_Str3("\n\r", 2));
		JB_SetRef(JB_str_243, JB_Str3("AZaz__����", 10));
		JB_SetRef(JB_str_242, JB_Str3("AZaz09__����", 12));
		...
		JB_SetRef(JB_str_149, JB_Str3("syntactic-comment", 17));
		...
		JB_SetRef(JB_str_144, JB_Str3("Can’t use temporals like this.", 32));
		...
		JB_SetRef(JB_str_135, JB_Str3("Can’t have '=' after this operator.", 37));
		...
		JB_SetRef(JB_str_126, JB_Str3("] ) } #/ /~ »", 14));
		...
		JB_SetRef(JB_str_107, JB_Str3("++ -- $ & ! \?", 13));
		JB_SetRef(JB_str_106, JB_Str3("* / + - ^ >> << >>> <<< ||| &&& ^^^", 35));
		JB_SetRef(JB_str_105, JB_Str3("= == === < > <= <== >= >== != !== <=> ~>= ~<= ~> ~< ~= ~!= ~<=> :=", 66));
		JB_SetRef(JB_str_104, JB_Str3("0123456789", 10));
		JB_SetRef(JB_str_103, JB_Str3("\r \n ,", 5));
		JB_SetRef(JB_str_102, JB_Str3("”", 3));
		JB_SetRef(JB_str_101, JB_Str3(" “", 4));
		...
		JB_SetRef(JB_str_75, JB_Str3("Missing child", 13));
...
bool JB_TestCasting() {
	...
	DTWrap* _tmP = JB_Incr(JB_Wrap__New(((int)({
		DTWrap* _tmP299 = JB_Incr(((DTWrap*)JB_Dict_SyntaxAccess(d2, JB_str_84)));
		int64 _tmP298 = JB_Wrap_Value(_tmP299);
		JB_Decr(_tmP299);
		 _tmP298;
	})) + 1));
...
void JB_AstUtil_UseLayer(AstUtil* self, Message* src) {
	...
	JB_MemoryLayer* L = JB_Incr(({
		JB_String* _tmP279 = JB_Incr(JB_Str_LowerCase(src->Name));
		JB_MemoryLayer* _tmP278 = JB_Incr(((JB_MemoryLayer*)JB_Dict_SyntaxAccess(self->Mem, _tmP279)));
		JB_Decr(_tmP279);
		JB_SafeDecr(_tmP278);
		 _tmP278;
	}));
...
JB_String* JB_Syntax_Render(Syntax self, FastString* fs_in) {
	...
	if (self) {
		JB_FreeIfDead(({
			SyntaxObj* _tmP282 = JB_Incr(JB_Syntax_Obj(self));
			JB_String* _tmP281 = JB_Incr(JB_Fn_Render(_tmP282, fs));
			JB_Decr(_tmP282);
			JB_SafeDecr(_tmP281);
			 _tmP281;
		}));
...
Message* JB_Str_ParseAs(JB_String* self, JB_String* name) {
	if ((!JB_Str_Exists(name)) or (JB_Str_SyntaxEquals(name, JB_str_168, true))) {
		...
		return ({
			Message* _tmP397 = JB_Incr(JB_Str_Parse(self, nil));
			Message* _tmP396 = JB_Incr(JB_Msg_ParseAST(_tmP397));
			JB_Decr(_tmP397);
			JB_SafeDecr(_tmP396);
			 _tmP396;
		});
...
JB_Object* JB_Dict_Syntax(Dictionary* self, JB_String* Key) {
	return ({
		JB_String* _tmP324 = JB_Incr(JB_Str_FastLower(Key));
		JB_Object* _tmP323 = JB_Incr(JB_Dict_SyntaxAccess(self, _tmP324));
		JB_Decr(_tmP324);
		JB_SafeDecr(_tmP323);
		 _tmP323;
	});
...
void JB_Msg_AccessErrInt(Message* self, int i) {
	JB_String* errnum = JB_Incr(JB_str_0);
	if (i) {
		JB_SetRef(errnum, ({
			JB_String* _tmP276 = JB_Incr(JB_int_Render(i, nil));
			JB_String* _tmP275 = JB_Incr(JB_Str_OperatorPlus(JB_str_14, _tmP276));
			JB_Decr(_tmP276);
			JB_SafeDecr(_tmP275);
			 _tmP275;
		}));
	}
	JB_String* _tmP = JB_Incr(JB_Str_OperatorPlus(JB_str_75, errnum));
	JB_Decr(errnum);
	JB_Rec_NewItemWithNode(JB_StdErr, self, _tmP);
	JB_Decr(_tmP);
}
...
Message* JB_Msg_Copy(Message* self, bool DefaultLayer) {
	if (DefaultLayer) {
		...
		return ({
			JB_MemoryLayer* _tmP245 = JB_Incr(JB_ObjLayer(self));
			Message* _tmP244 = JB_Incr(JB_Msg_LayerCopy(self, _tmP245));
			JB_Decr(_tmP245);
			JB_SafeDecr(_tmP244);
			 _tmP244;
		});
...
JB_String* JB_Msg_FuncName(Message* self) {
	return ({
		JB_String* _tmP271 = JB_Incr(JB_Syntax_LongName(self->Func));
		JB_String* _tmP270 = JB_Incr(JB_Str_LowerCase(_tmP271));
		JB_Decr(_tmP271);
		JB_SafeDecr(_tmP270);
		 _tmP270;
	});
	...
	} else {
		{
			...
			while (line) {
				...
				Message* children = JB_Incr(({
					Message* _tmP335 = JB_Incr(((Message*)JB_Ring_First(MsgDesc)));
					Message* _tmP334 = JB_Incr(((Message*)JB_Ring_NextSib(_tmP335)));
					JB_Decr(_tmP335);
					JB_SafeDecr(_tmP334);
					 _tmP334;
				}));
				...
				Message* Result = JB_Incr(({
					JB_String* _tmP337 = JB_Incr(({
						Message* _tmP339 = JB_Incr(((Message*)JB_Ring_NextSib(func)));
						JB_String* _tmP338 = JB_Incr(JB_Msg_Nyme(_tmP339));
						JB_Decr(_tmP339);
						JB_SafeDecr(_tmP338);
						 _tmP338;
					}));
					Message* _tmP336 = JB_Incr(JB_Msg__NewParser(self, fn->ID, self->Position, _tmP337));
					JB_Decr(_tmP337);
					JB_SafeDecr(_tmP336);
					 _tmP336;
				}));
...
void JB_Msg_Yoda__(Message* self, FastString* fs) {
	...
	Message* _tmP2 = JB_Incr(({
		Message* _tmP265 = JB_Incr(((Message*)JB_Ring_First(self)));
		Message* _tmP264 = JB_Incr(((Message*)JB_Ring_NextSib(_tmP265)));
		JB_Decr(_tmP265);
		JB_SafeDecr(_tmP264);
		 _tmP264;
	}));
...
// 3490376491474110898 8243569972669032653