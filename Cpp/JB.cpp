...
int JB_Constants__Init_() {
	{
		...
		JB_SetRef(JB__Constants_CSWordMiddle, JB_Str_Charset(JB_str_177, true));
		JB_SetRef(JB__Constants_CSWordStart, JB_Str_Charset(JB_str_178, true));
		JB_SetRef(JB__Constants_CSNum, JB__Constants_CSWordMiddle);
		JB_SetRef(JB__Constants_CSLine, JB_Str_Charset(JB_str_179, false));
		JB_SetRef(JB__Constants_CSAfterTemporal, JB_Str_Charset(JB_str_180, false));
		JB_SetRef(JB__Constants_CSLineBlack, JB_Str_Charset(JB_str_181, false));
		JB_SetRef(JB__Constants_CSNumUnit, JB_Str_Charset(JB_str_182, true));
	};
	return 0;
}
...
int JB_Init_() {
	{
		JB_SetRef(JB_str_255, JB_Str3("Binary", 6));
		JB_SetRef(JB_str_254, JB_Str3("bin", 3));
		JB_SetRef(JB_str_253, JB_Str3("unit", 4));
		JB_SetRef(JB_str_252, JB_Str3("Typecast", 8));
		JB_SetRef(JB_str_251, JB_Str3("type", 4));
		JB_SetRef(JB_str_250, JB_Str3("Conjugate", 9));
		JB_SetRef(JB_str_249, JB_Str3("cnj", 3));
		JB_SetRef(JB_str_248, JB_Str3("Syntactic_Conjugate", 19));
		JB_SetRef(JB_str_247, JB_Str3("scnj", 4));
		JB_SetRef(JB_str_246, JB_Str3("Temporal_Reference", 18));
		JB_SetRef(JB_str_245, JB_Str3("ana", 3));
		JB_SetRef(JB_str_244, JB_Str3("Temporal_Statement", 18));
		JB_SetRef(JB_str_243, JB_Str3("tmp", 3));
		JB_SetRef(JB_str_242, JB_Str3("Temporal_Chain", 14));
		JB_SetRef(JB_str_241, JB_Str3("chn", 3));
		JB_SetRef(JB_str_240, JB_Str3("Thing", 5));
		JB_SetRef(JB_str_239, JB_Str3("thg", 3));
		JB_SetRef(JB_str_238, JB_Str3("Syntactic_Thing", 15));
		JB_SetRef(JB_str_237, JB_Str3("sthg", 4));
		JB_SetRef(JB_str_236, JB_Str3("String", 6));
		JB_SetRef(JB_str_235, JB_Str3("str", 3));
		JB_SetRef(JB_str_234, JB_Str3("Shebang", 7));
		JB_SetRef(JB_str_233, JB_Str3("sheb", 4));
		JB_SetRef(JB_str_232, JB_Str3("Syntactic_Comment", 17));
		JB_SetRef(JB_str_231, JB_Str3("scom", 4));
		JB_SetRef(JB_str_230, JB_Str3("Self_Dot", 8));
		JB_SetRef(JB_str_229, JB_Str3("sdot", 4));
		JB_SetRef(JB_str_228, JB_Str3("Temporal_Relationship", 21));
		JB_SetRef(JB_str_227, JB_Str3("trel", 4));
		JB_SetRef(JB_str_226, JB_Str3("Relationship", 12));
		JB_SetRef(JB_str_225, JB_Str3("rel", 3));
		JB_SetRef(JB_str_224, JB_Str3("Syntactic_Operator", 18));
		JB_SetRef(JB_str_223, JB_Str3("sopp", 4));
		JB_SetRef(JB_str_222, JB_Str3("Operator", 8));
		JB_SetRef(JB_str_221, JB_Str3("opp", 3));
		JB_SetRef(JB_str_220, JB_Str3("Operator_As_Thing", 17));
		JB_SetRef(JB_str_219, JB_Str3("oat", 3));
		JB_SetRef(JB_str_218, JB_Str3("Number", 6));
		JB_SetRef(JB_str_217, JB_Str3("num", 3));
		JB_SetRef(JB_str_216, JB_Str3("name", 4));
		JB_SetRef(JB_str_215, JB_Str3("Parameters", 10));
		JB_SetRef(JB_str_214, JB_Str3("prm", 3));
		JB_SetRef(JB_str_213, JB_Str3("item", 4));
		JB_SetRef(JB_str_212, JB_Str3("Function", 8));
		JB_SetRef(JB_str_211, JB_Str3("func", 4));
		JB_SetRef(JB_str_210, JB_Str3("Equals_Relationship", 19));
		JB_SetRef(JB_str_209, JB_Str3("erel", 4));
		JB_SetRef(JB_str_208, JB_Str3("Embedded_Value", 14));
		JB_SetRef(JB_str_207, JB_Str3("emb", 3));
		JB_SetRef(JB_str_206, JB_Str3("Dot", 3));
		JB_SetRef(JB_str_205, JB_Str3("dot", 3));
		JB_SetRef(JB_str_204, JB_Str3("Declaration", 11));
		JB_SetRef(JB_str_203, JB_Str3("decl", 4));
		JB_SetRef(JB_str_202, JB_Str3("Character", 9));
		JB_SetRef(JB_str_201, JB_Str3("char", 4));
		JB_SetRef(JB_str_200, JB_Str3("Before_Relationship", 19));
		JB_SetRef(JB_str_199, JB_Str3("brel", 4));
		JB_SetRef(JB_str_198, JB_Str3("Bracket", 7));
		JB_SetRef(JB_str_197, JB_Str3("bra", 3));
		JB_SetRef(JB_str_196, JB_Str3("Super_String", 12));
		JB_SetRef(JB_str_195, JB_Str3("sstr", 4));
		JB_SetRef(JB_str_194, JB_Str3("Backtick", 8));
		JB_SetRef(JB_str_193, JB_Str3("back", 4));
		JB_SetRef(JB_str_192, JB_Str3("Array", 5));
		JB_SetRef(JB_str_191, JB_Str3("arr", 3));
		JB_SetRef(JB_str_190, JB_Str3("After_Relationship", 18));
		JB_SetRef(JB_str_189, JB_Str3("arel", 4));
		JB_SetRef(JB_str_188, JB_Str3("Adjective", 9));
		JB_SetRef(JB_str_187, JB_Str3("adj", 3));
		JB_SetRef(JB_str_186, JB_Str3("Access", 6));
		JB_SetRef(JB_str_185, JB_Str3("acc", 3));
		JB_SetRef(JB_str_184, JB_Str3("Argument", 8));
		JB_SetRef(JB_str_183, JB_Str3("arg", 3));
		JB_SetRef(JB_str_182, JB_Str3("AZazÄø¬Ù", 8));
		JB_SetRef(JB_str_181, JB_Str3("\n\r,", 3));
		JB_SetRef(JB_str_180, JB_Str3(" ,:\t\n\r\\", 7));
		JB_SetRef(JB_str_179, JB_Str3("\n\r", 2));
		JB_SetRef(JB_str_178, JB_Str3("AZaz__Äø¬Ù", 10));
		JB_SetRef(JB_str_177, JB_Str3("AZaz09__Äø¬Ù", 12));
		...
		JB_SetRef(JB_SyxArg, JB_Fn__StdNew(JB_Msg_Arg__, 0, JB_str_183, JB_str_184));
		JB_SetRef(JB_SyxAcc, JB_Fn__StdNew(JB_Msg_Acc__, 1, JB_str_185, JB_str_186));
		JB_SetRef(JB_SyxAdj, JB_Fn__StdNew(JB_Msg_Adj__, 2, JB_str_187, JB_str_188));
		JB_SetRef(JB_SyxARel, JB_Fn__StdNew(JB_Msg_ARel__, 3, JB_str_189, JB_str_190));
		JB_SetRef(JB_SyxArr, JB_Fn__StdNew(JB_Msg_Arr__, 4, JB_str_191, JB_str_192));
		JB_SetRef(JB_SyxBack, JB_Fn__StdNew(JB_Msg_Back__, 5, JB_str_193, JB_str_194));
		JB_SetRef(JB_SyxSStr, JB_Fn__StdNew(JB_Msg_SStr__, 6, JB_str_195, JB_str_196));
		JB_SetRef(JB_SyxBra, JB_Fn__StdNew(JB_Msg_Bra__, 7, JB_str_197, JB_str_198));
		JB_SetRef(JB_SyxBRel, JB_Fn__StdNew(JB_Msg_BRel__, 8, JB_str_199, JB_str_200));
		JB_SetRef(JB_SyxChar, JB_Fn__StdNew(JB_Msg_Char__, 9, JB_str_201, JB_str_202));
		JB_SetRef(JB_SyxDecl, JB_Fn__StdNew(JB_Msg_Decl__, 10, JB_str_203, JB_str_204));
		JB_SetRef(JB_SyxDot, JB_Fn__StdNew(JB_Msg_Dot__, 11, JB_str_205, JB_str_206));
		JB_SetRef(JB_SyxEmb, JB_Fn__StdNew(JB_Msg_Emb__, 12, JB_str_207, JB_str_208));
		JB_SetRef(JB_SyxERel, JB_Fn__StdNew(JB_Msg_ERel__, 13, JB_str_209, JB_str_210));
		JB_SetRef(JB_SyxFunc, JB_Fn__StdNew(JB_Msg_Func__, 14, JB_str_211, JB_str_212));
		JB_SetRef(JB_SyxItem, JB_Fn__StdNew(JB_Msg_Item__, 15, JB_str_213, JB_str_0));
		JB_SetRef(JB_SyxList, JB_Fn__StdNew(JB_Msg_List__, 16, JB_str_150, JB_str_0));
		JB_SetRef(JB_SyxPrm, JB_Fn__StdNew(JB_Msg_Prm__, 17, JB_str_214, JB_str_215));
		JB_SetRef(JB_SyxName, JB_Fn__StdNew(JB_Msg_Name__, 18, JB_str_216, JB_str_0));
		JB_SetRef(JB_SyxNum, JB_Fn__StdNew(JB_Msg_Num__, 19, JB_str_217, JB_str_218));
		JB_SetRef(JB_SyxOat, JB_Fn__StdNew(JB_Msg_Oat__, 20, JB_str_219, JB_str_220));
		JB_SetRef(JB_SyxOpp, JB_Fn__StdNew(JB_Msg_Opp__, 21, JB_str_221, JB_str_222));
		JB_SetRef(JB_SyxSOpp, JB_Fn__StdNew(JB_Msg_SOpp__, 22, JB_str_223, JB_str_224));
		JB_SetRef(JB_SyxRel, JB_Fn__StdNew(JB_Msg_Rel__, 23, JB_str_225, JB_str_226));
		JB_SetRef(JB_SyxTRel, JB_Fn__StdNew(JB_Msg_TRel__, 24, JB_str_227, JB_str_228));
		JB_SetRef(JB_SyxSDot, JB_Fn__StdNew(JB_Msg_SDot__, 25, JB_str_229, JB_str_230));
		JB_SetRef(JB_SyxSCom, JB_Fn__StdNew(JB_Msg_SCom__, 26, JB_str_231, JB_str_232));
		JB_SetRef(JB_SyxSheb, JB_Fn__StdNew(JB_Msg_Sheb__, 27, JB_str_233, JB_str_234));
		JB_SetRef(JB_SyxStr, JB_Fn__StdNew(JB_Msg_Str__, 28, JB_str_235, JB_str_236));
		JB_SetRef(JB_SyxSThg, JB_Fn__StdNew(JB_Msg_SThg__, 29, JB_str_237, JB_str_238));
		JB_SetRef(JB_SyxThg, JB_Fn__StdNew(JB_Msg_Thg__, 30, JB_str_239, JB_str_240));
		JB_SetRef(JB_SyxChn, JB_Fn__StdNew(JB_Msg_Chn__, 31, JB_str_241, JB_str_242));
		JB_SetRef(JB_SyxTmp, JB_Fn__StdNew(JB_Msg_Tmp__, 32, JB_str_243, JB_str_244));
		JB_SetRef(JB_SyxAna, JB_Fn__StdNew(JB_Msg_Ana__, 33, JB_str_245, JB_str_246));
		JB_SetRef(JB_SyxSCnj, JB_Fn__StdNew(JB_Msg_SCnj__, 34, JB_str_247, JB_str_248));
		JB_SetRef(JB_SyxCnj, JB_Fn__StdNew(JB_Msg_Cnj__, 35, JB_str_249, JB_str_250));
		JB_SetRef(JB_SyxType, JB_Fn__StdNew(JB_Msg_Type__, 36, JB_str_251, JB_str_252));
		JB_SetRef(JB_SyxUnit, JB_Fn__StdNew(JB_Msg_Unit__, 37, JB_str_253, JB_str_0));
		JB_SetRef(JB_SyxBin, JB_Fn__StdNew(JB_Msg_Bin__, 38, JB_str_254, JB_str_255));
	};
	//// JB_API;
	JB_API__Init_();
	//// Jeebox;
