...
int JB_Constants__Init_() {
	{
		...
		JB_SetRef(JB__Constants_CSWordMiddle, JB_Str_Charset(JB_str_243, true));
		JB_SetRef(JB__Constants_CSWordStart, JB_Str_Charset(JB_str_244, true));
		...
		JB_SetRef(JB__Constants_CSLettersOnly, JB_Str_Charset(JB_str_248, true));
...
JB_String* JB_Constants__Test() {
	...
	JB_Decr(fs);
	if ((!(({
		JB_String* _tmP397 = JB_Incr(({
			JB_String* _tmP399 = JB_Incr(JB_Str_Escape(str));
			JB_String* _tmP398 = JB_Incr(JB_Str_Unescape(_tmP399));
			JB_Decr(_tmP399);
			JB_SafeDecr(_tmP398);
			 _tmP398;
		}));
		bool _tmP396 = JB_Str_SyntaxEquals(_tmP397, str, false);
		JB_Decr(_tmP397);
		 _tmP396;
	})))) {
	...
	if (JB_Str_Exists(list_input)) {
		...
		Message* list = JB_Incr(({
			Message* _tmP401 = JB_Incr(JB_Str_Parse(list_input, nil));
...
int JB_Tk__EmbeddedArg(JB_String* close, Message* result, Syntax Syx) {
	...
	int _tmP = JB_Tk__EmbeddedCode(close, arg, Syx);
	JB_Decr(arg);
	return _tmP;
}
...
void JB_Tk__ErrorEvent2(int Start, int ExpectedBits, int RealBits) {
	...
	if (RealBits == kJB__Tk_EndOfLine) {
		...
		if (((bool)(RealBits & kJB__Tk_IllegalChar))) {
			...
			JB_String* _tmP1 = JB_Incr(({
				JB_String* _tmP389 = JB_Incr(JB_Str_Range(JB__Tk_Data, Start, N));
				JB_String* _tmP388 = JB_Incr(JB_Str_Escape(_tmP389));
				JB_Decr(_tmP389);
				JB_SafeDecr(_tmP388);
				 _tmP388;
			}));
	...
	JB_FreeIfDead(({
		JB_String* _tmP391 = JB_Incr(JB_FS_SyntaxCastString(Err));
		Message* _tmP390 = JB_Incr(JB_Tk__ErrorAdd(_tmP391, Start));
		JB_Decr(_tmP391);
		JB_SafeDecr(_tmP390);
		 _tmP390;
	}));
...
Message* JB_Tk__fBinary(int Start) {
	...
	Message* _tmP = JB_Incr(({
		JB_String* _tmP317 = JB_Incr(JB_Str_DecodeB64(S, nil));
		Message* _tmP316 = JB_Incr(JB_Tk__NewParentName(nil, JB_SyxBin, Start, _tmP317));
		JB_Decr(_tmP317);
		JB_SafeDecr(_tmP316);
		 _tmP316;
	}));
...
Message* JB_Tk__fChr(int Start) {
	...
	JB_String* name = JB_Incr(({
		JB_String* _tmP371 = JB_Incr(JB_Str_Range(JB__Tk_Data, Start + 1, After));
		JB_String* _tmP370 = JB_Incr(JB_Str_Unescape(_tmP371));
		JB_Decr(_tmP371);
		JB_SafeDecr(_tmP370);
		 _tmP370;
	}));
...
Message* JB_Tk__fMsgList(int Start) {
	...
	while ((!JB_Tk__WillEnd())) {
		...
		JB_Tk__ConsumeLines(Result, item, JB_SyxList);
		JB_Decr(item);
	};
...
Message* JB_Tk__fSyntacticComment(int Start) {
	...
	JB_Tk__EmbeddedArg(JB_str_140, Result, JB_SyxList);
	JB_SafeDecr(Result);
	return Result;
}
...
void JB_Tk__Init() {
	...
	JB_SetRef(JB__Tk_EndOfLineMarker, JB_Msg__NewFuncName(JB_SyxYoda, lines));
	JB_Tk__Tokenz(lines, kJB__Tk_EndOfLine, JB_Tk__fEndOfLine);
	JB_Decr(lines);
	...
	TokHan* H = JB_Incr(({
		TokHan* _tmP340 = JB_Incr(({
			TokHan* _tmP342 = JB_Incr(JB_Tk__Handler(kJB__Tk_ThingWord, ((TokenHandler_fp)JB_Tk__fThingWord)));
			TokHan* _tmP341 = JB_Incr(JB_TH_Link(_tmP342, kJB__Tk_TemporalWord, ((TokenHandler_fp)JB_Tk__fTemporalStatement)));
			JB_Decr(_tmP342);
			JB_SafeDecr(_tmP341);
			 _tmP341;
		}));
		TokHan* _tmP339 = JB_Incr(JB_TH_Link(_tmP340, kJB__Tk_OppWord, ((TokenHandler_fp)JB_Tk__fOppWord)));
		JB_Decr(_tmP340);
		JB_SafeDecr(_tmP339);
		 _tmP339;
	}));
	...
	TokHan* _tmP2 = JB_Incr(({
		TokHan* _tmP346 = JB_Incr(({
			TokHan* _tmP348 = JB_Incr(JB_Tk__Handler(kJB__Tk_FuncAfterNoSpace, ((TokenHandler_fp)JB_Tk__fFuncCall)));
			TokHan* _tmP347 = JB_Incr(JB_TH_Link(_tmP348, kJB__Tk_ThingSyx, ((TokenHandler_fp)JB_Tk__fBracket)));
			JB_Decr(_tmP348);
			JB_SafeDecr(_tmP347);
			 _tmP347;
		}));
		TokHan* _tmP345 = JB_Incr(JB_TH_Link(_tmP346, kJB__Tk_OppBra, ((TokenHandler_fp)JB_Tk__fOppBracket)));
		JB_Decr(_tmP346);
		JB_SafeDecr(_tmP345);
		 _tmP345;
	}));
	...
	TokHan* _tmP3 = JB_Incr(({
		TokHan* _tmP351 = JB_Incr(JB_Tk__Handler(kJB__Tk_FuncAfterNoSpace, ((TokenHandler_fp)JB_Tk__fAccess)));
		TokHan* _tmP350 = JB_Incr(JB_TH_Link(_tmP351, kJB__Tk_ThingSyx, ((TokenHandler_fp)JB_Tk__fArray)));
		JB_Decr(_tmP351);
		JB_SafeDecr(_tmP350);
		 _tmP350;
	}));
	...
	TokHan* _tmP5 = JB_Incr(({
		TokHan* _tmP355 = JB_Incr(JB_Tk__Handler(kJB__Tk_FuncAfterNoSpace, ((TokenHandler_fp)JB_Tk__fDot)));
		TokHan* _tmP354 = JB_Incr(JB_TH_Link(_tmP355, kJB__Tk_ThingSyx, ((TokenHandler_fp)JB_Tk__fSDot)));
		JB_Decr(_tmP355);
		JB_SafeDecr(_tmP354);
		 _tmP354;
	}));
	...
	TokHan* _tmP6 = JB_Incr(({
		TokHan* _tmP358 = JB_Incr(JB_Tk__Handler(kJB__Tk_FuncAfterBar, ((TokenHandler_fp)JB_Tk__fBarTypeCast)));
		TokHan* _tmP357 = JB_Incr(JB_TH_Link(_tmP358, kJB__Tk_TemporalSyx, ((TokenHandler_fp)JB_Tk__fDecl)));
		JB_Decr(_tmP358);
		JB_SafeDecr(_tmP357);
		 _tmP357;
	}));
	...
	TokHan* _tmP7 = JB_Incr(({
		TokHan* _tmP361 = JB_Incr(JB_Tk__Handler(kJB__Tk_ThingSyx, ((TokenHandler_fp)JB_Tk__fAtName)));
		TokHan* _tmP360 = JB_Incr(JB_TH_Link(_tmP361, kJB__Tk_FuncAfterNormal, ((TokenHandler_fp)JB_Tk__fAtNamedExp)));
		JB_Decr(_tmP361);
		JB_SafeDecr(_tmP360);
		 _tmP360;
	}));
	...
	TokHan* _tmP8 = JB_Incr(({
		TokHan* _tmP364 = JB_Incr(JB_Tk__Handler(kJB__Tk_FuncAfterNormal, ((TokenHandler_fp)JB_Tk__fAdjectiveThing)));
		TokHan* _tmP363 = JB_Incr(JB_TH_Link(_tmP364, kJB__Tk_adjectiveop, ((TokenHandler_fp)JB_Tk__fAdjectiveOp)));
		JB_Decr(_tmP364);
		JB_SafeDecr(_tmP363);
		 _tmP363;
	}));
	...
	JB_Decr(_tmP8);
	JB_Tk__Tokenz(JB_str_114, kJB__Tk_ThingSyx, JB_Tk__fBeforeRelMinus);
	JB_Tk__Tokenz(PFix, kJB__Tk_ThingSyx, JB_Tk__fBeforeRel);
	JB_Tk__Tokenz(PFix, kJB__Tk_FuncAfterNormal, JB_Tk__fAfterRel);
	JB_Decr(PFix);
	JB_Tk__Tokenz(JB_str_115, kJB__Tk_colon, JB_Tk__fEndOfLine);
	JB_Tk__Tokenz(JB_str_68, kJB__Tk_ThingSyx, JB_Tk__fTemporalAsThing);
	JB_Tk__Tokenz(JB_str_116, kJB__Tk_ThingSyx, JB_Tk__fArgOpen);
	JB_Tk__Tokenz(JB_str_117, kJB__Tk_TmpOpp, JB_Tk__fTemporalRel);
	JB_Tk__Tokenz(JB_str_118, kJB__Tk_TmpOpp, JB_Tk__fTemporalRelSyx);
	JB_Tk__Tokenz(JB_str_39, kJB__Tk_ThingSyx, JB_Tk__fOpAsThing);
	...
	JB_Tk__Tokenz(JB_str_119, kJB__Tk_EndOfLine, JB_Tk__fCommentLine);
	JB_Tk__Tokenz(JB_str_120, kJB__Tk_EndOfLine, JB_Tk__fComment);
	JB_Tk__Tokenz(op_comp, kJB__Tk_OppSyx, JB_Tk__fOppSyxNeq);
	JB_Decr(op_comp);
	JB_Tk__Tokenz(op_math, kJB__Tk_OppSyx, JB_Tk__fOppSyx);
	JB_Decr(op_math);
	JB_Tk__Tokenz(JB_str_121, kJB__Tk_OppYoda, JB_Tk__fOppYoda);
	JB_Tk__Tokenz(JB_str_122, kJB__Tk_ThingSyx, JB_Tk__fBunchOfThings);
	JB_Tk__Tokenz(JB_str_123, kJB__Tk_ThingSyx, JB_Tk__fThingSyx);
	JB_Tk__Tokenz(JB_str_51, kJB__Tk_ThingSyx, JB_Tk__fString2);
	JB_Tk__Tokenz(JB_str_22, kJB__Tk_ThingSyx, JB_Tk__fChr);
	JB_Tk__Tokenz(JB_str_124, kJB__Tk_ThingSyx, JB_Tk__fBackTick);
	JB_Tk__Tokenz(JB_str_62, kJB__Tk_ThingSyx, JB_Tk__fSuperStr);
	JB_Tk__Tokenz(JB_str_125, kJB__Tk_ThingSyx, JB_Tk__fBeforeRel);
	JB_Tk__Tokenz(JB_str_126, kJB__Tk_SyntacticComment, JB_Tk__fSyntacticComment);
	JB_Tk__Tokenz(JB_str_95, kJB__Tk_ThingSyx, JB_Tk__fBinary);
	JB_Tk__Tokenz(JB_str_127, kJB__Tk_EndContainer, JB_Tk__fEndOfLine);
	...
	(JB_Tk__TokenSet(JB_str_128, _tmP10));
	JB_Decr(_tmP10);
}
...
int JB_Tk__MessageErrorSub(FastString* fs, int num, int ButFound) {
	if ((!JB__Tk_ErrorNames)) {
		...
		(JB_Dict_a4(JB__Tk_ErrorNames, kJB__Tk_Temporal, JB_str_153));
		(JB_Dict_a4(JB__Tk_ErrorNames, kJB__Tk_TemporalSyx, JB_str_154));
		(JB_Dict_a4(JB__Tk_ErrorNames, kJB__Tk_TemporalWord, JB_str_155));
		(JB_Dict_a4(JB__Tk_ErrorNames, kJB__Tk_SyntacticComment, JB_str_150));
		(JB_Dict_a4(JB__Tk_ErrorNames, kJB__Tk_EndOfLine, JB_str_149));
		(JB_Dict_a4(JB__Tk_ErrorNames, kJB__Tk_colon, JB_str_156));
		(JB_Dict_a4(JB__Tk_ErrorNames, kJB__Tk_OppSyx, JB_str_157));
		(JB_Dict_a4(JB__Tk_ErrorNames, kJB__Tk_OppWord, JB_str_157));
		(JB_Dict_a4(JB__Tk_ErrorNames, kJB__Tk_Opp, JB_str_157));
		(JB_Dict_a4(JB__Tk_ErrorNames, kJB__Tk_OppTemporal, JB_str_158));
		(JB_Dict_a4(JB__Tk_ErrorNames, kJB__Tk_FuncAfterBar, JB_str_159));
		(JB_Dict_a4(JB__Tk_ErrorNames, kJB__Tk_Thing, JB_str_160));
		(JB_Dict_a4(JB__Tk_ErrorNames, kJB__Tk_ThingWord, JB_str_160));
		(JB_Dict_a4(JB__Tk_ErrorNames, kJB__Tk_ThingSyx, JB_str_161));
		(JB_Dict_a4(JB__Tk_ErrorNames, kJB__Tk_IllegalChar, JB_str_162));
	}
	if (JB_FS_Length(fs)) {
...
bool JB_Tk__ParseLoopMode(Message* Output, Syntax Syx) {
	int result = 0;
	if (JB_Tk__ConsumeLines(Output, nil, Syx)) {
		result = 2;
	}
	...
	while ((!JB_Tk__WillEnd())) {
		...
		result++;
		if ((!JB_Tk__ConsumeLines(Output, Item, Syx))) {
			JB_Decr(Item);
			break;
		}
		JB_Decr(Item);
...
void JB_Tk__Tokenz(JB_String* s, int bits, ParseHandler func) {
	if (JB_Str_OperatorContains(s, JB_str_14)) {
...
bool JB_Platform__linux() {
	return (({
		JB_String* _tmP222 = JB_Incr(JB_Platform());
		bool _tmP221 = JB_Str_SyntaxEquals(_tmP222, JB_str_34, false);
		JB_Decr(_tmP222);
		 _tmP221;
	}));
}
...
void JB_BinaryEscapeTest(JB_String* AllBytes) {
	...
	JB_String* a = JB_Incr(JB_str_45);
	{
		...
		while (_i1 < 10) {
			...
			JB_Decr(b);
			JB_SetRef(a, ({
				JB_String* _tmP236 = JB_Incr(JB_Str_OperatorPlus(JB_str_48, a));
				JB_String* _tmP235 = JB_Incr(JB_Str_OperatorPlus(a, _tmP236));
				JB_Decr(_tmP236);
				JB_SafeDecr(_tmP235);
				 _tmP235;
			}));
...
bool JB_CompareError(Message* expected, Message* found) {
	...
	JB_String* _tmP5 = JB_Incr(({
		Message* _tmP289 = JB_Incr(JB_Msg_PoorAnt(expected));
		JB_String* _tmP288 = JB_Incr(JB_Msg_Locate(_tmP289));
		JB_Decr(_tmP289);
		JB_SafeDecr(_tmP288);
		 _tmP288;
	}));
	...
	if (found) {
		...
		JB_String* _tmP6 = JB_Incr(({
			Message* _tmP292 = JB_Incr(JB_Msg_PoorAnt(found));
...
JB_String* JB_EntityTest() {
	...
	JB_String* result = JB_Incr(({
		JB_String* _tmP294 = JB_Incr(JB_Str_LowerCase(replicate));
		JB_String* _tmP293 = JB_Incr(JB_Str_OperatorPlus(_tmP294, JB_str_84));
		JB_Decr(_tmP294);
		JB_SafeDecr(_tmP293);
		 _tmP293;
	}));
...
int JB_Init_() {
	{
		...
		JB_SetRef(JB_str_248, JB_Str3("AZaz����", 8));
		JB_SetRef(JB_str_247, JB_Str3("\n\r,", 3));
		JB_SetRef(JB_str_246, JB_Str3(" ,:\t\n\r\\", 7));
		JB_SetRef(JB_str_245, JB_Str3("\n\r", 2));
		JB_SetRef(JB_str_244, JB_Str3("AZaz__����", 10));
		JB_SetRef(JB_str_243, JB_Str3("AZaz09__����", 12));
		...
		JB_SetRef(JB_str_150, JB_Str3("syntactic-comment", 17));
		...
		JB_SetRef(JB_str_127, JB_Str3("] ) } #/ /~ »", 14));
...
bool JB_TestCasting() {
	...
	DTWrap* _tmP = JB_Incr(JB_Wrap__New(((int)({
		DTWrap* _tmP297 = JB_Incr(((DTWrap*)JB_Dict_SyntaxAccess(d2, JB_str_85)));
		int64 _tmP296 = JB_Wrap_Value(_tmP297);
		JB_Decr(_tmP297);
		 _tmP296;
	})) + 1));
...
void JB_AstUtil_UseLayer(AstUtil* self, Message* src) {
	...
	JB_MemoryLayer* L = JB_Incr(({
		JB_String* _tmP277 = JB_Incr(JB_Str_LowerCase(src->Name));
		JB_MemoryLayer* _tmP276 = JB_Incr(((JB_MemoryLayer*)JB_Dict_SyntaxAccess(self->Mem, _tmP277)));
		JB_Decr(_tmP277);
		JB_SafeDecr(_tmP276);
		 _tmP276;
	}));
...
int JB_Syntax_Lineflags(Syntax self) {
	if (self == JB_SyxArg) {
		return kJB__Tk_EndOfLine | kJB__Tk_SyntacticComment;
	} else {
		return kJB__Tk_EndOfLine | (kJB__Tk_Comma | kJB__Tk_SyntacticComment);
	}
	return 0;
}
...
JB_String* JB_Syntax_Render(Syntax self, FastString* fs_in) {
	...
	if (self) {
		JB_FreeIfDead(({
			SyntaxObj* _tmP280 = JB_Incr(JB_Syntax_Obj(self));
			JB_String* _tmP279 = JB_Incr(JB_Fn_Render(_tmP280, fs));
			JB_Decr(_tmP280);
			JB_SafeDecr(_tmP279);
			 _tmP279;
		}));
...
Message* JB_Str_Parse(JB_String* self, Message* into) {
	...
	JB__Tk_ErrNode = ({
		Message* __imP = JB_Incr((JB_Syntax_Msg(JB_SyxArg, JB_str_0)));
		JB_SafeDecr(__imP);
		 __imP;
	});
	if ((!(into))) {
...
Message* JB_Str_ParseAs(JB_String* self, JB_String* name) {
	if ((!JB_Str_Exists(name)) or (JB_Str_SyntaxEquals(name, JB_str_169, true))) {
		...
		return ({
			Message* _tmP395 = JB_Incr(JB_Str_Parse(self, nil));
			Message* _tmP394 = JB_Incr(JB_Msg_ParseAST(_tmP395));
			JB_Decr(_tmP395);
			JB_SafeDecr(_tmP394);
			 _tmP394;
		});
...
JB_Object* JB_Dict_Syntax(Dictionary* self, JB_String* Key) {
	return ({
		JB_String* _tmP322 = JB_Incr(JB_Str_FastLower(Key));
		JB_Object* _tmP321 = JB_Incr(JB_Dict_SyntaxAccess(self, _tmP322));
		JB_Decr(_tmP322);
		JB_SafeDecr(_tmP321);
		 _tmP321;
	});
...
void JB_Err_GrabLine(JB_Error* self, FastString* fs, bool Usecolor) {
	...
	JB_String* _tmP = JB_Incr(({
		...
		JB_String* _tmP191 = JB_Incr(JB_Str_ReplaceAll(_tmP192, JB_str_16, JB_str_14, false, nil));
		JB_Decr(_tmP192);
		JB_SafeDecr(_tmP191);
		 _tmP191;
	}));
...
Message* JB_Msg_Copy(Message* self, bool DefaultLayer) {
	if (DefaultLayer) {
		...
		return ({
			JB_MemoryLayer* _tmP243 = JB_Incr(JB_ObjLayer(self));
			Message* _tmP242 = JB_Incr(JB_Msg_LayerCopy(self, _tmP243));
			JB_Decr(_tmP243);
			JB_SafeDecr(_tmP242);
			 _tmP242;
		});
...
JB_String* JB_Msg_FuncName(Message* self) {
	return ({
		JB_String* _tmP269 = JB_Incr(JB_Syntax_LongName(self->Func));
		JB_String* _tmP268 = JB_Incr(JB_Str_LowerCase(_tmP269));
		JB_Decr(_tmP269);
		JB_SafeDecr(_tmP268);
		 _tmP268;
	});
	...
	} else {
		{
			...
			while (line) {
				...
				Message* children = JB_Incr(({
					Message* _tmP333 = JB_Incr(((Message*)JB_Ring_First(MsgDesc)));
					Message* _tmP332 = JB_Incr(((Message*)JB_Ring_NextSib(_tmP333)));
					JB_Decr(_tmP333);
					JB_SafeDecr(_tmP332);
					 _tmP332;
				}));
				...
				Message* itm = JB_Incr(JB_Msg_AccessFirst(MsgDesc, JB_SyxItem));
				JB_Decr(MsgDesc);
				if ((!itm)) {
					JB_Decr(line);
					JB_Decr(children);
				...
				Message* Result = JB_Incr(({
					JB_String* _tmP335 = JB_Incr(({
						Message* _tmP337 = JB_Incr(((Message*)JB_Ring_NextSib(func)));
						JB_String* _tmP336 = JB_Incr(JB_Msg_Nyme(_tmP337));
						JB_Decr(_tmP337);
						JB_SafeDecr(_tmP336);
						 _tmP336;
					}));
					Message* _tmP334 = JB_Incr(JB_Msg__NewParser(self, fn->ID, self->Position, _tmP335));
					JB_Decr(_tmP335);
					JB_SafeDecr(_tmP334);
					 _tmP334;
				}));
...
Message* JB_Msg_AccessFirst(Message* self, Syntax s) {
	if ((!self)) {
		return nil;
	}
...
void JB_Msg_Yoda__(Message* self, FastString* fs) {
	...
	Message* _tmP2 = JB_Incr(({
		Message* _tmP263 = JB_Incr(((Message*)JB_Ring_First(self)));
		Message* _tmP262 = JB_Incr(((Message*)JB_Ring_NextSib(_tmP263)));
		JB_Decr(_tmP263);
		JB_SafeDecr(_tmP262);
		 _tmP262;
	}));
...
// 3490376491474110898 -5078866133368302950