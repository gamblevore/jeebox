...
int JB_Constants__Init_() {
	{
		...
		(JB_Dict_ValueSet(JB__Constants_EscapeStr, JB_str_178, JB_str_50));
		(JB_Dict_ValueSet(JB__Constants_EscapeStr, JB_str_42, JB_str_77));
		(JB_Dict_ValueSet(JB__Constants_EscapeStr, JB_str_179, JB_str_180));
		(JB_Dict_ValueSet(JB__Constants_EscapeStr, JB_str_15, JB_str_181));
		(JB_Dict_ValueSet(JB__Constants_EscapeStr, JB_str_49, JB_str_182));
		(JB_Dict_ValueSet(JB__Constants_EscapeStr, JB_str_21, JB_str_183));
		(JB_Dict_ValueSet(JB__Constants_EscapeStr, JB_str_52, JB_str_184));
		(JB_Dict_ValueSet(JB__Constants_EscapeStr, JB_str_185, JB_str_186));
		JB_SetRef(JB__Constants_JS_EscapeStr, JB_Dict__New());
		(JB_Dict_ValueSet(JB__Constants_JS_EscapeStr, JB_str_187, JB_str_188));
		(JB_Dict_ValueSet(JB__Constants_JS_EscapeStr, JB_str_189, JB_str_190));
		(JB_Dict_ValueSet(JB__Constants_JS_EscapeStr, JB_str_42, JB_str_77));
		(JB_Dict_ValueSet(JB__Constants_JS_EscapeStr, JB_str_179, JB_str_180));
		(JB_Dict_ValueSet(JB__Constants_JS_EscapeStr, JB_str_15, JB_str_181));
		(JB_Dict_ValueSet(JB__Constants_JS_EscapeStr, JB_str_49, JB_str_182));
		(JB_Dict_ValueSet(JB__Constants_JS_EscapeStr, JB_str_52, JB_str_184));
		...
		JB_SetRef(JB__Constants_CSWordMiddle, JB_Str_Charset(JB_str_191, true));
		JB_SetRef(JB__Constants_CSWordStart, JB_Str_Charset(JB_str_192, true));
		JB_SetRef(JB__Constants_CSNum, JB__Constants_CSWordMiddle);
		JB_SetRef(JB__Constants_CSLine, JB_Str_Charset(JB_str_193, false));
		JB_SetRef(JB__Constants_CSAfterTemporal, JB_Str_Charset(JB_str_194, false));
		JB_SetRef(JB__Constants_CSLineBlack, JB_Str_Charset(JB_str_195, false));
		JB_SetRef(JB__Constants_CSNumUnit, JB_Str_Charset(JB_str_196, true));
...
void JB_Constants__InitConstants() {
	JB_SetRef(JB__Constants_EscapeChr, JB_Dict_Copy(JB__Constants_EscapeStr));
	{
		...
		while (_i < 256) {
			...
			JB_String* _tmp2 = JB_Incr(JB_Str_OperatorPlus(JB_str_47, cr));
	...
	(JB_Dict_ValueSet(JB__Constants_EscapeChr, JB_str_47, ((JB_String*)nil)));
	(JB_Dict_ValueSet(JB__Constants_UnEscapeStr, JB_str_50, ((JB_String*)nil)));
	(JB_Dict_ValueSet(JB__Constants_UnEscapeStr, JB_str_51, JB_str_0));
	...
	(JB_Dict_ValueSet(JB__Constants_EscapeStr, JB_str_53, JB_str_54));
}
...
JB_String* JB_Constants__Test() {
	...
	JB_Decr(fs);
	if ((!(({
		JB_String* _tmp357 = JB_Incr(JB_Str_Unescape(JB_Str_Escape(str)));
		bool _tmp356 = JB_Str_SyntaxEquals(_tmp357, str, false);
		JB_Decr(_tmp357);
		_tmp356;
	})))) {
	...
	JB_String* natural_input = JB_Incr(JB_str_162);
	JB_String* list_input = JB_Incr(JB_str_163);
	if ((!(JB_TestCasting()))) {
		debugger;
	}
	int i1 = JB_Str_InWhite(JB_str_80, 0, kJB__int_max);
	if ((!(i1 == 3))) {
		debugger;
	}
	int i2 = JB_Str_OutWhite(JB_str_164, 0, kJB__int_max);
	if ((!(!(JB_int_Found(i2))))) {
		debugger;
	}
	int i3 = JB_Str_OutWhite(JB_str_165, 0, kJB__int_max);
	if ((!(JB_int_Found(i3)))) {
		debugger;
	}
	int i4 = JB_Str_InWhite(JB_str_166, JB_Str_Length(JB_str_166), 1);
	if ((!(i4 == 1))) {
		debugger;
	}
	JB_String* x = JB_Incr(JB_Str_UpperCase(JB_str_158));
	JB_Decr(x);
	LeakTester* LKT = JB_Incr(JB_Lk__New(JB_str_167));
	...
	if (JB_Str_Exists(list_input)) {
		...
		({
			Message* _tmp359 = JB_Incr(JB_Msg_Copy(root, false));
			bool _tmp358 = JB_Msg_TreeCompare(root, _tmp359);
			JB_Decr(_tmp359);
			_tmp358;
		});
		Message* list = JB_Incr(({
			Message* _tmp361 = JB_Incr(JB_Str_Parse(list_input, nil));
		...
		JB_Msg_Test(root, _tmp1, JB_str_158);
		JB_Decr(_tmp1);
		JB_String* _tmp2 = JB_Incr(JB_Msg_MakeReadable(root, nil));
		JB_Msg_Test(root, _tmp2, JB_str_159);
		JB_Decr(_tmp2);
		JB_Decr(root);
	} else {
		Message* root = JB_Incr(JB_Str_Parse(natural_input, nil));
		...
		JB_Msg_Test(root, R, JB_str_158);
		JB_Decr(root);
		JB_Str_Print(JB_str_168);
		JB_Str_Print(R);
		JB_Decr(R);
	}
	JB_Decr(list_input);
...
int JB_Tk__EmbeddedCode(JB_String* close, Message* dest, int Mode) {
	int result = JB_Str_FindStr(JB__Tk_Data, JB_Tk__NextStart(), close);
	if ((!JB_int_Found(result))) {
		FastString* _fs_fs = JB_Incr(JB_FS__New());
		JB_FS_AppendString(_fs_fs, JB_str_69);
	...
	if (JB_Tk__NextStart() > result) {
		...
		JB_FS_AppendString(_fs1_fs, JB_str_130);
		JB_FS_AppendString(_fs1_fs, close);
		JB_FS_AppendString(_fs1_fs, JB_str_131);
...
void JB_Tk__ErrorEvent2(int Start, int ExpectedBits, int RealBits) {
	...
	if ((!(((bool)(RealBits & kJB__Tk_IllegalChar))))) {
		if ((!ExpectedBits) or ((!RealBits) or (!JB_Tk__FindError(ExpectedBits)))) {
			...
			JB_FS_AppendString(Err, JB_str_72);
		}
	}
	if (RealBits == kJB__Tk_EndOfLine) {
		...
		if (((bool)(RealBits & kJB__Tk_IllegalChar))) {
			...
			JB_String* _tmp1 = JB_Incr(({
				JB_String* _tmp347 = JB_Incr(JB_Str_AccessRange(JB__Tk_Data, Start, N));
				JB_String* _tmp346 = JB_Incr(JB_Str_Escape(_tmp347));
				JB_Decr(_tmp347);
				JB_SafeDecr(_tmp346);
				_tmp346;
			}));
	...
	({
		JB_String* _tmp349 = JB_Incr(JB_FS_SyntaxCastString(Err));
		Message* _tmp348 = JB_Incr(JB_Tk__ErrorAdd(_tmp349, Start, false));
		JB_Decr(_tmp349);
		JB_SafeDecr(_tmp348);
		_tmp348;
	});
...
void JB_Tk__ErrorLetter(int Start) {
	JB_FreeIfDead(JB_Tk__ErrorAdd(JB_str_134, Start, false));
}
...
bool JB_Tk__ExpectEndChar(byte s, bool Expect) {
	...
	if (Expect) {
		FastString* _fs_fs = JB_Incr(JB_FS__New());
		JB_FS_AppendString(_fs_fs, JB_str_121);
...
Message* JB_Tk__fBackTick(int Start) {
	return JB_Tk__fStrSub(Start, JB_str_117, JB_SyxBack);
}
...
Message* JB_Tk__fBinary(int Start) {
	int End = JB_Str_FindStr(JB__Tk_Data, Start + 2, JB_str_89);
	if ((!JB_int_Found(End))) {
		return JB_Tk__ErrorAdd(JB_str_90, JB_Tk__NextStart(), false);
	}
	JB_String* S = JB_Incr(JB_Str_AccessRange(JB__Tk_Data, Start + 2, End));
	(JB_Tk__NextStartSet(End + 2));
	Message* _tmp = JB_Incr(({
		JB_String* _tmp292 = JB_Incr(JB_Str_DecodeB64(S, nil));
		Message* _tmp291 = JB_Incr(JB_Tk__NewParentName(nil, JB_SyxBin, Start, _tmp292));
		JB_Decr(_tmp292);
		JB_SafeDecr(_tmp291);
		_tmp291;
	}));
...
Message* JB_Tk__fChr(int Start) {
	...
	if ((!JB_int_Found(After))) {
		return JB_Tk__ErrorAdd(JB_str_123, JB_Tk__NextStart(), false);
	}
	(JB_Tk__NextStartSet(After + 1));
	JB_String* name = JB_Incr(({
		JB_String* _tmp330 = JB_Incr(JB_Str_AccessRange(JB__Tk_Data, Start + 1, After));
		JB_String* _tmp329 = JB_Incr(JB_Str_Unescape(_tmp330));
		JB_Decr(_tmp330);
		JB_SafeDecr(_tmp329);
		_tmp329;
	}));
...
Message* JB_Tk__fComment(int Start) {
	...
	while (true) {
		...
		if ((!JB_int_Found(i))) {
			JB_Decr(d);
			return JB_Tk__ErrorAdd(JB_str_124, Start, false);
...
Message* JB_Tk__fCommentLine(int Start) {
	(JB_Tk__NextStartSet(JB_Str_InCharSet(JB__Tk_Data, JB_Tk__NextStart(), kJB__int_max, JB__Constants_CSLine)));
	return JB_Tk__Avoid();
}
...
Message* JB_Tk__fShebang(int Start) {
	...
	int S2 = JB_Str_InCharSet(JB__Tk_Data, S, kJB__int_max, JB__Constants_CSLine);
...
Message* JB_Tk__fString2(int Start) {
	int After = JB_Str_JBFind(JB__Tk_Data, JB_Tk__NextStart(), kJB__int_max, '"');
	if ((!JB_int_Found(After))) {
		return JB_Tk__ErrorAdd(JB_str_126, JB_Tk__NextStart(), false);
	}
	int StrPos = Start + 1;
	...
	while (true) {
		...
		if (C0 == '{') {
			StrPos = JB_Tk__EmbeddedCode(JB_str_127, result, JB_Fn_Parseflags(JB_SyxList));
		} else {
			StrPos = JB_Str_OutCharSet(JB__Tk_Data, NewStrPos + 1, After, JB__Constants_CSWordMiddle);
		...
		if (StrPos > After) {
			JB_Decr(result);
			return JB_Tk__ErrorAdd(JB_str_128, NewStrPos, false);
		}
	};
	(JB_Tk__NextStartSet(After + 1));
...
Message* JB_Tk__fStrSub(int Start, JB_String* Ender, Syntax* syx) {
	int After = JB_Str_FindStr(JB__Tk_Data, JB_Tk__NextStart(), Ender);
	if ((!JB_int_Found(After))) {
...
Message* JB_Tk__GetFuncAfter(Message* input) {
	...
	while (true) {
		...
		if ((!JB_Msg_SyxOppEquals(d, JB_SyxName, false))) {
			...
			JB_FreeIfDead(JB_Tk__ErrorAdd(JB_str_132, JB_Tk__NextStart(), false));
		} else {
...
void JB_Tk__Init() {
	JB_String* lines = JB_Incr(JB_str_97);
	Array* numb = JB_Incr(JB_Str_ByteSplit(JB_str_98));
	JB_String* op_comp = JB_Incr(JB_str_99);
	JB_String* op_math = JB_Incr(JB_str_100);
	JB_String* PFix = JB_Incr(JB_str_101);
	TokHan* H = JB_Incr(({
		TokHan* _tmp305 = JB_Incr(JB_TH_Link(JB_Tk__Handler(kJB__Tk_ThingWord, ((TokenHandler_fp)JB_Tk__fThingWord)), kJB__Tk_TemporalWord, ((TokenHandler_fp)JB_Tk__fTemporalStatement)));
		TokHan* _tmp304 = JB_Incr(JB_TH_Link(_tmp305, kJB__Tk_OppWord, ((TokenHandler_fp)JB_Tk__fOppWord)));
		JB_Decr(_tmp305);
		JB_SafeDecr(_tmp304);
		_tmp304;
	}));
	...
	TokHan* _tmp2 = JB_Incr(({
		TokHan* _tmp309 = JB_Incr(JB_TH_Link(JB_Tk__Handler(kJB__Tk_FuncAfterNoSpace, ((TokenHandler_fp)JB_Tk__fFuncCall)), kJB__Tk_ThingSyx, ((TokenHandler_fp)JB_Tk__fBracket)));
		TokHan* _tmp308 = JB_Incr(JB_TH_Link(_tmp309, kJB__Tk_OppBra, ((TokenHandler_fp)JB_Tk__fOppBracket)));
		JB_Decr(_tmp309);
		JB_SafeDecr(_tmp308);
		_tmp308;
	}));
	(JB_Tk__TokenSet(JB_str_102, _tmp2));
	JB_Decr(_tmp2);
	TokHan* _tmp3 = JB_Incr(({
		TokHan* _tmp312 = JB_Incr(JB_Tk__Handler(kJB__Tk_FuncAfterNoSpace, ((TokenHandler_fp)JB_Tk__fAccess)));
		TokHan* _tmp311 = JB_Incr(JB_TH_Link(_tmp312, kJB__Tk_ThingSyx, ((TokenHandler_fp)JB_Tk__fArray)));
		JB_Decr(_tmp312);
		JB_SafeDecr(_tmp311);
		_tmp311;
	}));
	(JB_Tk__TokenSet(JB_str_103, _tmp3));
	JB_Decr(_tmp3);
	TokHan* _tmp4 = JB_Incr(({
		TokHan* _tmp315 = JB_Incr(JB_Tk__Handler(kJB__Tk_FuncAfterNoSpace, ((TokenHandler_fp)JB_Tk__fDot)));
		TokHan* _tmp314 = JB_Incr(JB_TH_Link(_tmp315, kJB__Tk_ThingSyx, ((TokenHandler_fp)JB_Tk__fSDot)));
		JB_Decr(_tmp315);
		JB_SafeDecr(_tmp314);
		_tmp314;
	}));
	(JB_Tk__TokenSet(JB_str_26, _tmp4));
	JB_Decr(_tmp4);
	TokHan* _tmp5 = JB_Incr(({
		TokHan* _tmp318 = JB_Incr(JB_Tk__Handler(kJB__Tk_FuncAfterBar, ((TokenHandler_fp)JB_Tk__fBarTypeCast)));
		TokHan* _tmp317 = JB_Incr(JB_TH_Link(_tmp318, kJB__Tk_TemporalSyx, ((TokenHandler_fp)JB_Tk__fDecl)));
		JB_Decr(_tmp318);
		JB_SafeDecr(_tmp317);
		_tmp317;
	}));
	(JB_Tk__TokenSet(JB_str_104, _tmp5));
	JB_Decr(_tmp5);
	TokHan* _tmp6 = JB_Incr(({
		TokHan* _tmp321 = JB_Incr(JB_Tk__Handler(kJB__Tk_ThingSyx, ((TokenHandler_fp)JB_Tk__fAtName)));
		TokHan* _tmp320 = JB_Incr(JB_TH_Link(_tmp321, kJB__Tk_FuncAfterNormal, ((TokenHandler_fp)JB_Tk__fAtNamedExp)));
		JB_Decr(_tmp321);
		JB_SafeDecr(_tmp320);
		_tmp320;
	}));
	(JB_Tk__TokenSet(JB_str_105, _tmp6));
	JB_Decr(_tmp6);
	TokHan* _tmp7 = JB_Incr(({
		TokHan* _tmp324 = JB_Incr(JB_Tk__Handler(kJB__Tk_FuncAfterNormal, ((TokenHandler_fp)JB_Tk__fAdjectiveThing)));
		TokHan* _tmp323 = JB_Incr(JB_TH_Link(_tmp324, kJB__Tk_adjectiveop, ((TokenHandler_fp)JB_Tk__fAdjectiveOp)));
		JB_Decr(_tmp324);
		JB_SafeDecr(_tmp323);
		_tmp323;
	}));
	(JB_Tk__TokenSet(JB_str_106, _tmp7));
	JB_Decr(_tmp7);
	JB_Tk__Tokenz(JB_str_107, kJB__Tk_ThingSyx, JB_Tk__fBeforeRelMinus);
	JB_Tk__Tokenz(PFix, kJB__Tk_ThingSyx, JB_Tk__fBeforeRel);
	JB_Tk__Tokenz(PFix, kJB__Tk_FuncAfterNormal, JB_Tk__fAfterRel);
	JB_Decr(PFix);
	JB_Tk__Tokenz(JB_str_108, kJB__Tk_colon, nil);
	JB_Tk__Tokenz(JB_str_67, kJB__Tk_ThingSyx, JB_Tk__fTemporalAsThing);
	JB_Tk__Tokenz(JB_str_109, kJB__Tk_ThingSyx, JB_Tk__fStatementOpen);
	JB_Tk__Tokenz(JB_str_110, kJB__Tk_TmpOpp, JB_Tk__fTemporalRel);
	JB_Tk__Tokenz(JB_str_111, kJB__Tk_TmpOpp, JB_Tk__fTemporalRelSyx);
	JB_Tk__Tokenz(JB_str_37, kJB__Tk_ThingSyx, JB_Tk__fOpAsThing);
	JB_Tk__Tokenz(JB_str_112, kJB__Tk_ThingSyx, JB_Tk__fAnaphoricReference);
	JB_Tk__Tokens(numb, kJB__Tk_ThingSyx, JB_Tk__fNumber);
	JB_Decr(numb);
	JB_Tk__Tokenz(JB_str_66, kJB__Tk_TemporalSyx, JB_Tk__fShebang);
	JB_Tk__Tokenz(JB_str_113, kJB__Tk_EndOfLine + kJB__Tk_words_line, JB_Tk__fCommentLine);
	JB_Tk__Tokenz(JB_str_114, kJB__Tk_EndOfLine + kJB__Tk_words_line, JB_Tk__fComment);
	JB_Tk__Tokenz(lines, kJB__Tk_EndOfLine + kJB__Tk_words_line, nil);
	JB_Decr(lines);
	JB_Tk__Tokenz(JB_str_115, kJB__Tk_EndOfLine, nil);
	JB_Tk__Tokenz(op_comp, kJB__Tk_OppSyx, JB_Tk__fOppSyxNeq);
	JB_Decr(op_comp);
	JB_Tk__Tokenz(op_math, kJB__Tk_OppSyx, JB_Tk__fOppSyx);
	JB_Decr(op_math);
	JB_Tk__Tokenz(JB_str_116, kJB__Tk_ThingSyx, JB_Tk__fThingSyx);
	JB_Tk__Tokenz(JB_str_49, kJB__Tk_ThingSyx, JB_Tk__fString2);
	JB_Tk__Tokenz(JB_str_21, kJB__Tk_ThingSyx, JB_Tk__fChr);
	JB_Tk__Tokenz(JB_str_117, kJB__Tk_ThingSyx, JB_Tk__fBackTick);
	JB_Tk__Tokenz(JB_str_61, kJB__Tk_ThingSyx, JB_Tk__fSuperStr);
	JB_Tk__Tokenz(JB_str_118, kJB__Tk_ThingSyx, JB_Tk__fBeforeRel);
	JB_Tk__Tokenz(JB_str_119, kJB__Tk_SyntacticComment, JB_Tk__fSyntacticComment);
	JB_Tk__Tokenz(JB_str_88, kJB__Tk_ThingSyx, JB_Tk__fBinary);
	JB_Tk__Tokenz(JB_str_120, kJB__Tk_EndContainer, nil);
...
int JB_Tk__MessageErrorSub(FastString* fs, int num, int ButFound) {
	if ((!JB__Tk_ErrorNames)) {
		...
		(JB_Dict_a4(JB__Tk_ErrorNames, kJB__Tk_Temporal, JB_str_141));
		(JB_Dict_a4(JB__Tk_ErrorNames, kJB__Tk_TemporalSyx, JB_str_142));
		(JB_Dict_a4(JB__Tk_ErrorNames, kJB__Tk_TemporalWord, JB_str_143));
		(JB_Dict_a4(JB__Tk_ErrorNames, kJB__Tk_SyntacticComment, JB_str_137));
		(JB_Dict_a4(JB__Tk_ErrorNames, kJB__Tk_EndOfLine, JB_str_136));
		(JB_Dict_a4(JB__Tk_ErrorNames, kJB__Tk_colon, JB_str_144));
		(JB_Dict_a4(JB__Tk_ErrorNames, kJB__Tk_OppSyx, JB_str_145));
		(JB_Dict_a4(JB__Tk_ErrorNames, kJB__Tk_OppWord, JB_str_146));
		(JB_Dict_a4(JB__Tk_ErrorNames, kJB__Tk_OppTemporal, JB_str_147));
		(JB_Dict_a4(JB__Tk_ErrorNames, kJB__Tk_Opp, JB_str_146));
		(JB_Dict_a4(JB__Tk_ErrorNames, kJB__Tk_FuncAfterBar, JB_str_148));
		(JB_Dict_a4(JB__Tk_ErrorNames, kJB__Tk_Thing, JB_str_149));
		(JB_Dict_a4(JB__Tk_ErrorNames, kJB__Tk_ThingWord, JB_str_149));
		(JB_Dict_a4(JB__Tk_ErrorNames, kJB__Tk_ThingSyx, JB_str_150));
		(JB_Dict_a4(JB__Tk_ErrorNames, kJB__Tk_IllegalChar, JB_str_151));
	}
	if (JB_FS_Length(fs)) {
		JB_FS_AppendString(fs, JB_str_152);
	} else {
	...
	if (BestValue) {
		JB_String* _tmp = JB_Incr(({
			JB_String* _tmp352 = JB_Incr(JB_int_DictName(BestValue));
			JB_String* _tmp351 = JB_Incr(((JB_String*)JB_Dict_Value(JB__Tk_ErrorNames, _tmp352)));
			JB_Decr(_tmp352);
			JB_SafeDecr(_tmp351);
			_tmp351;
		}));
...
Message* JB_Tk__NewParent(Message* Parent, Syntax* Func, int Start, int End) {
	JB_String* Name = JB_Str_AccessRange(JB__Tk_Data, Start, End);
...
Message* JB_Tk__NumberSub(int Start, int RealStart) {
	...
	JB_FreeIfDead(JB_Tk__NewParent(Num, JB_SyxUnit, UnitPos2, After));
	return Num;
}
...
Message* JB_Tk__ReRoute(Message* cnj, Message* output) {
	...
	if ((!f)) {
		JB_FreeIfDead(JB_Tk__ErrorAdd(JB_str_133, JB_Tk__NextStart(), false));
		JB_Decr(f);
		return nil;
	}
...
int JB_Tk__WordAfter(int Start) {
	int After = JB_Str_OutCharSet(JB__Tk_Data, Start, kJB__int_max, JB__Constants_CSWordMiddle);
...
bool JB_Platform__linux() {
	return (({
		JB_String* _tmp216 = JB_Incr(JB_Platform());
		bool _tmp215 = JB_Str_SyntaxEquals(_tmp216, JB_str_32, false);
		JB_Decr(_tmp216);
		_tmp215;
	}));
}
...
void JB_BinaryEscapeTest(JB_String* AllBytes) {
	...
	JB_String* a = JB_Incr(JB_str_43);
	{
		...
		while (_i1 < 10) {
			...
			JB_Decr(b);
			JB_SetRef(a, ({
				JB_String* _tmp229 = JB_Incr(JB_Str_OperatorPlus(JB_str_46, a));
				JB_String* _tmp228 = JB_Incr(JB_Str_OperatorPlus(a, _tmp229));
				JB_Decr(_tmp229);
				JB_SafeDecr(_tmp228);
				_tmp228;
			}));
...
bool JB_CompareError(Message* expected, Message* found) {
	...
	JB_Decr(_tmp3);
	JB_FS_AppendString(_fs_fs, JB_str_72);
	...
	JB_Decr(_fs_str);
	FastString* _fs1_fs = JB_Incr(JB_FS__New());
	JB_FS_AppendString(_fs1_fs, JB_str_73);
	JB_String* _tmp5 = JB_Incr(({
		Message* _tmp264 = JB_Incr(JB_Msg_PoorAnt(expected));
		JB_String* _tmp263 = JB_Incr(JB_Msg_Locate(_tmp264));
		JB_Decr(_tmp264);
		JB_SafeDecr(_tmp263);
		_tmp263;
	}));
	...
	if (found) {
		...
		JB_FS_AppendString(_fs2_fs, JB_str_74);
		JB_String* _tmp6 = JB_Incr(({
			Message* _tmp267 = JB_Incr(JB_Msg_PoorAnt(found));
			JB_String* _tmp266 = JB_Incr(JB_Msg_Locate(_tmp267));
			JB_Decr(_tmp267);
			JB_SafeDecr(_tmp266);
			_tmp266;
		}));
...
JB_String* JB_EntityTest() {
	JB_String* raw = JB_Incr(JB_str_75);
	JB_String* replicate = JB_Incr(JB_str_76);
	Dictionary* repl = JB_Incr(JB_Dict__New());
	(JB_Dict_ValueSet(repl, JB_str_77, JB_str_42));
	...
	JB_String* result = JB_Incr(({
		JB_String* _tmp269 = JB_Incr(JB_Str_LowerCase(replicate));
		JB_String* _tmp268 = JB_Incr(JB_Str_OperatorPlus(_tmp269, JB_str_78));
		JB_Decr(_tmp269);
		JB_SafeDecr(_tmp268);
		_tmp268;
	}));
...
int JB_Init_() {
	{
		JB_SetRef(JB_str_266, JB_Str3("Binary", 6));
		JB_SetRef(JB_str_265, JB_Str3("bin", 3));
		JB_SetRef(JB_str_264, JB_Str3("\n{\n\t\"glossary\": {\n\t\t\"title\": \"example glossary\",\n\t\t\"GlossDiv\": {\n\t\t\t\"title\": \"S\",\n\t\t\t\"GlossList\": {\n\t\t\t\t\"GlossEntry\": {\n\t\t\t\t\t\"ID\": \"SGML\",\n\t\t\t\t\t\"SortAs\": \"SGML\",\n\t\t\t\t\t\"GlossTerm\": \"Standard \\\\Generalized Markup Language\",\n\t\t\t\t\t\"Acronym\": \"SGML\",\n\t\t\t\t\t\"Abbrev\": \"ISO 8879:1986\",\n\t\t\t\t\t\"GlossDef\": {\n\t\t\t\t\t\t\"para\": \"A meta-markup language, \\nused to create markup languages such as \\\"DocBook\\\".\",\n\t\t\t\t\t\t\"GlossSeeAlso\": [\"GML\", \"XML\"]\n\t\t\t\t\t},\n\t\t\t\t\t\"GlossSee\": \"markup\"\n\t\t\t\t}\n\t\t\t}\n\t\t}\n\t}\n}\n", 484));
		JB_SetRef(JB_str_263, JB_Str3("Typecast", 8));
		JB_SetRef(JB_str_262, JB_Str3("type", 4));
		JB_SetRef(JB_str_261, JB_Str3("Conjugate", 9));
		JB_SetRef(JB_str_260, JB_Str3("cnj", 3));
		JB_SetRef(JB_str_259, JB_Str3("Syntactic_Conjugate", 19));
		JB_SetRef(JB_str_258, JB_Str3("scnj", 4));
		JB_SetRef(JB_str_257, JB_Str3("Temporal_Reference", 18));
		JB_SetRef(JB_str_256, JB_Str3("ana", 3));
		JB_SetRef(JB_str_255, JB_Str3("Temporal_Statement", 18));
		JB_SetRef(JB_str_254, JB_Str3("tmp", 3));
		JB_SetRef(JB_str_253, JB_Str3("Thing", 5));
		JB_SetRef(JB_str_252, JB_Str3("thg", 3));
		JB_SetRef(JB_str_251, JB_Str3("Syntactic_Thing", 15));
		JB_SetRef(JB_str_250, JB_Str3("sthg", 4));
		JB_SetRef(JB_str_249, JB_Str3("String", 6));
		JB_SetRef(JB_str_248, JB_Str3("str", 3));
		JB_SetRef(JB_str_247, JB_Str3("Shebang", 7));
		JB_SetRef(JB_str_246, JB_Str3("sheb", 4));
		JB_SetRef(JB_str_245, JB_Str3("Syntactic_Comment", 17));
		JB_SetRef(JB_str_244, JB_Str3("scom", 4));
		JB_SetRef(JB_str_243, JB_Str3("Self_Dot", 8));
		JB_SetRef(JB_str_242, JB_Str3("sdot", 4));
		JB_SetRef(JB_str_241, JB_Str3("Temporal_Relationship", 21));
		JB_SetRef(JB_str_240, JB_Str3("trel", 4));
		JB_SetRef(JB_str_239, JB_Str3("Relationship", 12));
		JB_SetRef(JB_str_238, JB_Str3("rel", 3));
		JB_SetRef(JB_str_237, JB_Str3("Syntactic_Operator", 18));
		JB_SetRef(JB_str_236, JB_Str3("sopp", 4));
		JB_SetRef(JB_str_235, JB_Str3("Operator", 8));
		JB_SetRef(JB_str_234, JB_Str3("opp", 3));
		JB_SetRef(JB_str_233, JB_Str3("Operator_As_Thing", 17));
		JB_SetRef(JB_str_232, JB_Str3("oat", 3));
		JB_SetRef(JB_str_231, JB_Str3("unit", 4));
		JB_SetRef(JB_str_230, JB_Str3("Number", 6));
		JB_SetRef(JB_str_229, JB_Str3("num", 3));
		JB_SetRef(JB_str_228, JB_Str3("name", 4));
		JB_SetRef(JB_str_227, JB_Str3("item", 4));
		JB_SetRef(JB_str_226, JB_Str3("Function", 8));
		JB_SetRef(JB_str_225, JB_Str3("func", 4));
		JB_SetRef(JB_str_224, JB_Str3("Equals_Relationship", 19));
		JB_SetRef(JB_str_223, JB_Str3("erel", 4));
		JB_SetRef(JB_str_222, JB_Str3("Embedded_Value", 14));
		JB_SetRef(JB_str_221, JB_Str3("emb", 3));
		JB_SetRef(JB_str_220, JB_Str3("Dot", 3));
		JB_SetRef(JB_str_219, JB_Str3("dot", 3));
		JB_SetRef(JB_str_218, JB_Str3("Declaration", 11));
		JB_SetRef(JB_str_217, JB_Str3("decl", 4));
		JB_SetRef(JB_str_216, JB_Str3("Character", 9));
		JB_SetRef(JB_str_215, JB_Str3("char", 4));
		JB_SetRef(JB_str_214, JB_Str3("Before_Relationship", 19));
		JB_SetRef(JB_str_213, JB_Str3("brel", 4));
		JB_SetRef(JB_str_212, JB_Str3("Bracket", 7));
		JB_SetRef(JB_str_211, JB_Str3("bra", 3));
		JB_SetRef(JB_str_210, JB_Str3("Super_String", 12));
		JB_SetRef(JB_str_209, JB_Str3("sstr", 4));
		JB_SetRef(JB_str_208, JB_Str3("Backtick", 8));
		JB_SetRef(JB_str_207, JB_Str3("back", 4));
		JB_SetRef(JB_str_206, JB_Str3("Array", 5));
		JB_SetRef(JB_str_205, JB_Str3("arr", 3));
		JB_SetRef(JB_str_204, JB_Str3("After_Relationship", 18));
		JB_SetRef(JB_str_203, JB_Str3("arel", 4));
		JB_SetRef(JB_str_202, JB_Str3("Adjective", 9));
		JB_SetRef(JB_str_201, JB_Str3("adj", 3));
		JB_SetRef(JB_str_200, JB_Str3("Access", 6));
		JB_SetRef(JB_str_199, JB_Str3("acc", 3));
		JB_SetRef(JB_str_198, JB_Str3("Argument", 8));
		JB_SetRef(JB_str_197, JB_Str3("arg", 3));
		JB_SetRef(JB_str_196, JB_Str3("AZazÄø¬Ù", 8));
		JB_SetRef(JB_str_195, JB_Str3("\n\r,", 3));
		JB_SetRef(JB_str_194, JB_Str3(" ,:\t\n\r\\", 7));
		JB_SetRef(JB_str_193, JB_Str3("\n\r", 2));
		JB_SetRef(JB_str_192, JB_Str3("AZaz__Äø¬Ù", 10));
		JB_SetRef(JB_str_191, JB_Str3("AZaz09__Äø¬Ù", 12));
		JB_SetRef(JB_str_190, JB_Str3("\\f", 2));
		JB_SetRef(JB_str_189, JB_Str3("", 1));
		JB_SetRef(JB_str_188, JB_Str3("\\b", 2));
		JB_SetRef(JB_str_187, JB_Str3("", 1));
		JB_SetRef(JB_str_186, JB_Str3("\\&#", 3));
		JB_SetRef(JB_str_185, JB_Str3("&#", 2));
		JB_SetRef(JB_str_184, JB_Str3("\\\\", 2));
		JB_SetRef(JB_str_183, JB_Str3("\\'", 2));
		JB_SetRef(JB_str_182, JB_Str3("\\\"", 2));
		JB_SetRef(JB_str_181, JB_Str3("\\t", 2));
		JB_SetRef(JB_str_180, JB_Str3("\\r", 2));
		JB_SetRef(JB_str_179, JB_Str3("\r", 1));
		JB_SetRef(JB_str_178, JB_Str3("\0", 1));
		JB_SetRef(JB_str_177, JB_Str3("[0;1;33m", 9));
		JB_SetRef(JB_str_176, JB_Str3("[0;1;32m", 9));
		JB_SetRef(JB_str_175, JB_Str3("[0;1;31m", 9));
		JB_SetRef(JB_str_174, JB_Str3("[0;1m", 6));
		JB_SetRef(JB_str_173, JB_Str3("[0m", 4));
		JB_SetRef(JB_str_172, JB_Str3("@JBSave\n", 8));
		JB_SetRef(JB_str_171, JB_Str3("').", 3));
		JB_SetRef(JB_str_170, JB_Str3("' (found '", 10));
		JB_SetRef(JB_str_169, JB_Str3("Can‚Äôt parse number '", 22));
		JB_SetRef(JB_str_168, JB_Str3("Manual inspection:\n\n", 20));
		JB_SetRef(JB_str_167, JB_Str3("entities", 8));
		JB_SetRef(JB_str_166, JB_Str3("  abc", 5));
		JB_SetRef(JB_str_165, JB_Str3(" a", 2));
		JB_SetRef(JB_str_164, JB_Str3("  ", 2));
		JB_SetRef(JB_str_163, JB_Str3("\n(tmp: \"how\"\n\t(oat: \n\t\t(opp: \"can\")\n\t\t(trel: \n\t\t\t(rel: \n\t\t\t\t(ana: \"someone\")\n\t\t\t\t(opp: \"fall\")\n\t\t\t\t(adj: \n\t\t\t\t\t(thg: \"so\")\n\t\t\t\t\t(thg: \"far\")\n\t\t\t\t)\n\t\t\t)\n\t\t\t(cnj: \"without\")\n\t\t\t(oat: \n\t\t\t\t(opp: \"realising\")\n\t\t\t\t(thg: \"‚Äìit\")\n\t\t\t)\n\t\t)\n\t)\n)\n(tmp: \"story\"\n\t(thg: \"X\")\n\t(list: \n\t\t(trel: \n\t\t\t(rel: \n\t\t\t\t(thg: \"x\")\n\t\t\t\t(bra: \n\t\t\t\t\t(adj: \n\t\t\t\t\t\t(opp: \"a\")\n\t\t\t\t\t\t(opp: \"b\")\n\t\t\t\t\t)\n\t\t\t\t)\n\t\t\t\t(ana: \"c\")\n\t\t\t)\n\t\t\t(scnj: \"-->\")\n\t\t\t(rel: \n\t\t\t\t(ana: \"You\")\n\t\t\t\t(opp: \"can\")\n\t\t\t\t(oat: \n\t\t\t\t\t(opp: \"describe\")\n\t\t\t\t\t(list: \n\t\t\t\t\t\t(thg: \"anything\")\n\t\t\t\t\t\t(item: \n\t\t\t\t\t\t\t(thg: \"with\")\n\t\t\t\t\t\t\t(rel: \n\t\t\t\t\t\t\t\t(name: \"sonic\"\n\t\t\t\t\t\t\t\t\t(adj: \n\t\t\t\t\t\t\t\t\t\t(thg: \"the\")\n\t\t\t\t\t\t\t\t\t\t(thg: \"hedgedog\")\n\t\t\t\t\t\t\t\t\t)\n\t\t\t\t\t\t\t\t)\n\t\t\t\t\t\t\t\t(opp: \"or\")\n\t\t\t\t\t\t\t\t(name: \"jeebox\")\n\t\t\t\t\t\t\t)\n\t\t\t\t\t\t)\n\t\t\t\t\t)\n\t\t\t\t)\n\t\t\t)\n\t\t)\n\t\t(trel: \n\t\t\t(rel: \n\t\t\t\t(thg: \"A\")\n\t\t\t\t(bra: \n\t\t\t\t\t(rel: \n\t\t\t\t\t\t(adj: \n\t\t\t\t\t\t\t(bra: \n\t\t\t\t\t\t\t\t(adj: \n\t\t\t\t\t\t\t\t\t(opp: \"B\")\n\t\t\t\t\t\t\t\t\t(opp: \"C\")\n\t\t\t\t\t\t\t\t)\n\t\t\t\t\t\t\t)\n\t\t\t\t\t\t\t(opp: \"D\")\n\t\t\t\t\t\t)\n\t\t\t\t\t\t(opp: \"E\")\n\t\t\t\t\t\t(adj: \n\t\t\t\t\t\t\t(opp: \"F\")\n\t\t\t\t\t\t\t(opp: \"G\")\n\t\t\t\t\t\t)\n\t\t\t\t\t)\n\t\t\t\t)\n\t\t\t\t(thg: \"I\")\n\t\t\t)\n\t\t\t(cnj: \"W\")\n\t\t\t(rel: \n\t\t\t\t(thg: \"A\")\n\t\t\t\t(opp: \"t\")\n\t\t\t\t(list: \n\t\t\t\t\t(item: \n\t\t\t\t\t\t(thg: \"o\")\n\t\t\t\t\t\t(thg: \"c\")\n\t\t\t\t\t)\n\t\t\t\t)\n\t\t\t)\n\t\t)\n\t)\n)\n(tmp: \"za\"\n\t(tmp: \"xb\"\n\t\t(arg: \n\t\t\t(decl: \n\t\t\t\t(num: \"1\")\n\t\t\t\t(rel: \n\t\t\t\t\t(thg: \"x\")\n\t\t\t\t\t(opp: \"*\")\n\t\t\t\t\t(rel: \n\t\t\t\t\t\t(thg: \"y\")\n\t\t\t\t\t\t(opp: \"*\")\n\t\t\t\t\t\t(rel: \n\t\t\t\t\t\t\t(thg: \"z\")\n\t\t\t\t\t\t\t(opp: \"=\")\n\t\t\t\t\t\t\t(brel: \"\?\"\n\t\t\t\t\t\t\t\t(arel: \"\?\"\n\t\t\t\t\t\t\t\t\t(list: )\n\t\t\t\t\t\t\t\t)\n\t\t\t\t\t\t\t)\n\t\t\t\t\t\t)\n\t\t\t\t\t)\n\t\t\t\t)\n\t\t\t)\n\t\t\t(decl: \n\t\t\t\t(emb: )\n\t\t\t\t(rel: \n\t\t\t\t\t(thg: \"a\")\n\t\t\t\t\t(opp: \"=\")\n\t\t\t\t\t(rel: \n\t\t\t\t\t\t(thg: \"c\")\n\t\t\t\t\t\t(opp: \"or\")\n\t\t\t\t\t\t(thg: \"d\")\n\t\t\t\t\t)\n\t\t\t\t)\n\t\t\t)\n\t\t\t(scom: \n\t\t\t\t(arg: \n\t\t\t\t\t(rel: \n\t\t\t\t\t\t(adj: \n\t\t\t\t\t\t\t(thg: \"vvv\")\n\t\t\t\t\t\t\t(thg: \"fff\")\n\t\t\t\t\t\t)\n\t\t\t\t\t\t(adj: \n\t\t\t\t\t\t\t(opp: \"v\")\n\t\t\t\t\t\t\t(opp: \"f\")\n\t\t\t\t\t\t)\n\t\t\t\t\t)\n\t\t\t\t)\n\t\t\t\t(list: \n\t\t\t\t\t(thg: \"a\")\n\t\t\t\t)\n\t\t\t)\n\t\t\t(list: \n\t\t\t\t(trel: \n\t\t\t\t\t(arr: )\n\t\t\t\t\t(scnj: \"-->\")\n\t\t\t\t\t(rel: \n\t\t\t\t\t\t(thg: \"a\")\n\t\t\t\t\t\t(opp: \"+\")\n\t\t\t\t\t\t(thg: \"a\")\n\t\t\t\t\t)\n\t\t\t\t)\n\t\t\t\t(thg: \"b\")\n\t\t\t\t(item: \n\t\t\t\t\t(thg: \"d\")\n\t\t\t\t\t(thg: \"e\")\n\t\t\t\t)\n\t\t\t)\n\t\t\t(arr: \n\t\t\t\t(type: \n\t\t\t\t\t(thg: \"d\")\n\t\t\t\t\t(num: \"0\")\n\t\t\t\t)\n\t\t\t\t(item: \n\t\t\t\t\t(rel: \n\t\t\t\t\t\t(thg: \"a\")\n\t\t\t\t\t\t(opp: \"+\")\n\t\t\t\t\t\t(thg: \"b\")\n\t\t\t\t\t)\n\t\t\t\t\t(thg: \"c\")\n\t\t\t\t)\n\t\t\t\t(arr: \n\t\t\t\t\t(thg: \"c\")\n\t\t\t\t\t(thg: \"d\")\n\t\t\t\t)\n\t\t\t)\n\t\t)\n\t)\n)\n(bin: \"binary encoding oof\")\n(tmp: \"function\"\n\t(thg: \"name\")\n\t(list: \n\t\t(decl: \n\t\t\t(item: \n\t\t\t\t(thg: \"x\")\n\t\t\t\t(rel: \n\t\t\t\t\t(thg: \"y\")\n\t\t\t\t\t(opp: \"+\")\n\t\t\t\t\t(thg: \"z\")\n\t\t\t\t)\n\t\t\t)\n\t\t\t(adj: \n\t\t\t\t(thg: \"a\")\n\t\t\t\t(thg: \"b\")\n\t\t\t)\n\t\t)\n\t\t(decl: \n\t\t\t(emb: )\n\t\t)\n\t)\n\t(arg: \n\t\t(item: \n\t\t\t(thg: \"label\")\n\t\t\t(func: \n\t\t\t\t(thg: \"func\")\n\t\t\t\t(list: )\n\t\t\t)\n\t\t)\n\t\t(str: \"'\\\"stri√±g test\\\"'\")\n\t\t(back: \"\\\\n\\\\(\\&#x134;\\&#xEB;\\\\C3\\\\AA\\\\C6\\\\81o\\&#9447;\\\\)\")\n\t\t(erel: \n\t\t\t(brel: \"--\"\n\t\t\t\t(arel: \"--\"\n\t\t\t\t\t(thg: \"x\")\n\t\t\t\t)\n\t\t\t)\n\t\t\t(opp: \"mod\")\n\t\t\t(char: \"ioi '\\\"\\\"'oio\")\n\t\t)\n\t\t(dot: \"y\"\n\t\t\t(dot: \"size\"\n\t\t\t\t(thg: \"y\")\n\t\t\t\t(list: \n\t\t\t\t\t(arel: \"\?\"\n\t\t\t\t\t\t(sthg: \"...\")\n\t\t\t\t\t)\n\t\t\t\t\t(sthg: \"...\")\n\t\t\t\t\t(sstr: \"s`t`r\")\n\t\t\t\t)\n\t\t\t)\n\t\t\t(list: \n\t\t\t\t(brel: \"-\"\n\t\t\t\t\t(thg: \"z\")\n\t\t\t\t)\n\t\t\t)\n\t\t)\n\t\t(rel: \n\t\t\t(thg: \"x\")\n\t\t\t(opp: \"=\")\n\t\t\t(rel: \n\t\t\t\t(str: \n\t\t\t\t\t(emb: \"{ab\")\n\t\t\t\t\t(thg: \"x\")\n\t\t\t\t\t(emb: \" \")\n\t\t\t\t\t(thg: \"y\")\n\t\t\t\t\t(thg: \"z\")\n\t\t\t\t\t(emb: \"ab}\")\n\t\t\t\t)\n\t\t\t\t(opp: \"+\")\n\t\t\t\t(back: \"abc\")\n\t\t\t)\n\t\t)\n\t\t(erel: \n\t\t\t(type: \n\t\t\t\t(thg: \"z\")\n\t\t\t\t(list: \n\t\t\t\t\t(thg: \"a\")\n\t\t\t\t)\n\t\t\t)\n\t\t\t(opp: \"+\")\n\t\t\t(sdot: \"exit\"\n\t\t\t\t(list: \n\t\t\t\t\t(item: \n\t\t\t\t\t\t(thg: \"code\")\n\t\t\t\t\t\t(num: \"-3\")\n\t\t\t\t\t)\n\t\t\t\t)\n\t\t\t)\n\t\t)\n\t\t(tmp: \"for\"\n\t\t\t(list: \n\t\t\t\t(item: \n\t\t\t\t\t(thg: \"a\")\n\t\t\t\t\t(thg: \"b\")\n\t\t\t\t)\n\t\t\t)\n\t\t\t(arg: \n\t\t\t\t(rel: \n\t\t\t\t\t(brel: \"$\"\n\t\t\t\t\t\t(arel: \"$\"\n\t\t\t\t\t\t\t(thg: \"a\")\n\t\t\t\t\t\t)\n\t\t\t\t\t)\n\t\t\t\t\t(opp: \"=\")\n\t\t\t\t\t(rel: \n\t\t\t\t\t\t(brel: \"&\"\n\t\t\t\t\t\t\t(arel: \"&\"\n\t\t\t\t\t\t\t\t(thg: \"b\")\n\t\t\t\t\t\t\t)\n\t\t\t\t\t\t)\n\t\t\t\t\t\t(opp: \"+\")\n\t\t\t\t\t\t(brel: \"!\"\n\t\t\t\t\t\t\t(arel: \"!\"\n\t\t\t\t\t\t\t\t(thg: \"c\")\n\t\t\t\t\t\t\t)\n\t\t\t\t\t\t)\n\t\t\t\t\t)\n\t\t\t\t)\n\t\t\t)\n\t\t)\n\t\t(tmp: \"if\"\n\t\t\t(rel: \n\t\t\t\t(bra: \n\t\t\t\t\t(rel: \n\t\t\t\t\t\t(char: \"a\")\n\t\t\t\t\t\t(opp: \"&&&\")\n\t\t\t\t\t\t(rel: \n\t\t\t\t\t\t\t(thg: \"b\")\n\t\t\t\t\t\t\t(opp: \"===\")\n\t\t\t\t\t\t\t(rel: \n\t\t\t\t\t\t\t\t(brel: \"!\"\n\t\t\t\t\t\t\t\t\t(brel: \"!\"\n\t\t\t\t\t\t\t\t\t\t(brel: \"!\"\n\t\t\t\t\t\t\t\t\t\t\t(thg: \"b\")\n\t\t\t\t\t\t\t\t\t\t)\n\t\t\t\t\t\t\t\t\t)\n\t\t\t\t\t\t\t\t)\n\t\t\t\t\t\t\t\t(opp: \"|||\")\n\t\t\t\t\t\t\t\t(thg: \"c\")\n\t\t\t\t\t\t\t)\n\t\t\t\t\t\t)\n\t\t\t\t\t)\n\t\t\t\t)\n\t\t\t\t(opp: \"^^^\")\n\t\t\t\t(bra: \n\t\t\t\t\t(rel: \n\t\t\t\t\t\t(thg: \"a\")\n\t\t\t\t\t\t(opp: \"~>=\")\n\t\t\t\t\t\t(thg: \"b\")\n\t\t\t\t\t)\n\t\t\t\t)\n\t\t\t)\n\t\t\t(arg: \n\t\t\t\t(tmp: \"return\"\n\t\t\t\t\t(tmp: \"return\"\n\t\t\t\t\t\t(rel: \n\t\t\t\t\t\t\t(num: \"0ff_\"\n\t\t\t\t\t\t\t\t(unit: \"x\")\n\t\t\t\t\t\t\t)\n\t\t\t\t\t\t\t(opp: \"+\")\n\t\t\t\t\t\t\t(num: \"10_\"\n\t\t\t\t\t\t\t\t(unit: \"miles\")\n\t\t\t\t\t\t\t)\n\t\t\t\t\t\t)\n\t\t\t\t\t)\n\t\t\t\t)\n\t\t\t)\n\t\t)\n\t)\n)\n", 4468));
		JB_SetRef(JB_str_162, JB_Str3("// Jeebox self-test file.\n// Tests all syntax in small amount of code.\n// Does not make sense in any other way.\n\nhow %can \\someone fall so~far #without %realising ‚Äìit\n\n\nstory X (\n\tx (a ~ \\\n\t\tb) \\c\n\t\t\t-->\n\t~~You can % describe (anything, with:sonic@the~hedgedog or @jeebox)\n\n\tA ((B~C)~D E F~G) I #W A t (o:c)\n)\n\n\n\n\nza::xb {\n\t|1| x * y * z = \?()\?\n\t|| a = c or d\n\t(a,) /#vvv~fff v~f#/\n\t([] --> a + a,b,d:e)\n\t[d|0|, a+b:c, [c, d]] /* /*\n\t\tnested comments!\n\t\t*/ I found it useful.*/\n\n\t// }\n}\n\n#(OcbkON9v86LkOszaQMvd86zlPW)#\n\nfunction name (|x:y+z| a ~ b, ||) {\n\tlabel: func()\n\t\"'\\\"stri\\c3\\b1g test\\\"'\"\n\t`\\n\\(&#x134;&#xEB;\\C3\\AA\\C6\\81o&#9447;\\)`\n\t--x-- mod= 'ioi \\'\"\"\\'oio'\n\t\n\ty.size(...\?, ..., <(`s`t`r`)>).y(-z)\n\n\tx = \"{ab$\{x} $\{y}$\{z}ab}\" + `abc`\n\tz|(a,)| += .exit(code: -3)\n\n\tfor (a : b) {\n\t\t\$a$ = &b& + !c!\n\t}\n\n\tif ('a' &&& b === !!!b ||| c) ^^^ (a ~>= b) {\n\t\treturn::return 0ff_x + 10_miles\n\t}\n}\n\n\n", 900));
		JB_SetRef(JB_str_161, JB_Str3(": Failed\n\n", 10));
		JB_SetRef(JB_str_160, JB_Str3("Test ", 5));
		JB_SetRef(JB_str_159, JB_Str3("list", 4));
		JB_SetRef(JB_str_158, JB_Str3("normal", 6));
		JB_SetRef(JB_str_157, JB_Str3(" in ", 4));
		JB_SetRef(JB_str_156, JB_Str3("' at byte: ", 11));
		JB_SetRef(JB_str_155, JB_Str3(": '", 3));
		JB_SetRef(JB_str_154, JB_Str3("(nil)", 5));
		JB_SetRef(JB_str_153, JB_Str3("something else", 14));
		JB_SetRef(JB_str_152, JB_Str3(" / ", 3));
		JB_SetRef(JB_str_151, JB_Str3("illegal-character", 17));
		JB_SetRef(JB_str_150, JB_Str3("something", 9));
		JB_SetRef(JB_str_149, JB_Str3("a name", 6));
		JB_SetRef(JB_str_148, JB_Str3("'|'", 3));
		JB_SetRef(JB_str_147, JB_Str3("temporal-operator", 17));
		JB_SetRef(JB_str_146, JB_Str3("operator", 8));
		JB_SetRef(JB_str_145, JB_Str3("syntactic-operator", 18));
		JB_SetRef(JB_str_144, JB_Str3("':'", 3));
		JB_SetRef(JB_str_143, JB_Str3("temporal-word", 13));
		JB_SetRef(JB_str_142, JB_Str3("declaration", 11));
		JB_SetRef(JB_str_141, JB_Str3("temporal", 8));
		JB_SetRef(JB_str_140, JB_Str3("0x", 2));
		JB_SetRef(JB_str_139, JB_Str3("Found illegal-character ", 24));
		JB_SetRef(JB_str_138, JB_Str3("end-of-data", 11));
		JB_SetRef(JB_str_137, JB_Str3("syntactic-comment", 17));
		JB_SetRef(JB_str_136, JB_Str3("end-of-line", 11));
		JB_SetRef(JB_str_135, JB_Str3("Unexpected ", 11));
		JB_SetRef(JB_str_134, JB_Str3("Expected a letter (aA-zZ, '_', etc).", 36));
		JB_SetRef(JB_str_133, JB_Str3("Can‚Äôt use temporals like this.", 32));
		JB_SetRef(JB_str_132, JB_Str3("Must be a proper name (a-z or letters)", 38));
		JB_SetRef(JB_str_131, JB_Str3("' not allowed.", 14));
		JB_SetRef(JB_str_130, JB_Str3("Nested '", 8));
		JB_SetRef(JB_str_129, JB_Str3("#/", 2));
		JB_SetRef(JB_str_128, JB_Str3("Embedded expression didn't close.", 33));
		JB_SetRef(JB_str_127, JB_Str3("}", 1));
		JB_SetRef(JB_str_126, JB_Str3("String didn't close!", 20));
		JB_SetRef(JB_str_125, JB_Str3("Can‚Äôt have '=' after this operator.", 37));
		JB_SetRef(JB_str_124, JB_Str3("Comment did not close.", 22));
		JB_SetRef(JB_str_123, JB_Str3("Char didn't close!", 18));
		JB_SetRef(JB_str_122, JB_Str3("String did not close.", 21));
		JB_SetRef(JB_str_121, JB_Str3("Missing '", 9));
		JB_SetRef(JB_str_120, JB_Str3("] ) } #/ /~", 11));
		...
		JB_SetRef(JB_str_114, JB_Str3("/*", 2));
		JB_SetRef(JB_str_113, JB_Str3("//", 2));
		JB_SetRef(JB_str_112, JB_Str3("\\ ~~", 4));
		JB_SetRef(JB_str_111, JB_Str3("--> <-- <-->", 12));
		JB_SetRef(JB_str_110, JB_Str3("#", 1));
		JB_SetRef(JB_str_109, JB_Str3("{", 1));
		JB_SetRef(JB_str_108, JB_Str3(":", 1));
		JB_SetRef(JB_str_107, JB_Str3("- *", 3));
		...
		JB_SetRef(JB_str_101, JB_Str3("++ -- $ & ! \?", 13));
		JB_SetRef(JB_str_100, JB_Str3("* / + - ^ >> << >>> <<< ||| &&& ^^^", 35));
		JB_SetRef(JB_str_99, JB_Str3("= == === < > <= <== >= >== != !== <=> ~>= ~<= ~> ~< ~= ~!= ~<=> :=", 66));
		JB_SetRef(JB_str_98, JB_Str3("0123456789", 10));
		JB_SetRef(JB_str_97, JB_Str3("\r \n", 3));
		JB_SetRef(JB_str_96, JB_Str3("‚Äù", 3));
		JB_SetRef(JB_str_95, JB_Str3(" ‚Äú", 4));
		JB_SetRef(JB_str_94, JB_Str3("Unexpected syntax. Found ", 25));
		JB_SetRef(JB_str_93, JB_Str3(", but found ", 12));
		JB_SetRef(JB_str_92, JB_Str3("' ", 2));
		JB_SetRef(JB_str_91, JB_Str3(" '", 2));
		JB_SetRef(JB_str_90, JB_Str3("Binary section didn't close!", 28));
		JB_SetRef(JB_str_89, JB_Str3(")#", 2));
		JB_SetRef(JB_str_88, JB_Str3("#(", 2));
		JB_SetRef(JB_str_87, JB_Str3("nil", 3));
		JB_SetRef(JB_str_86, JB_Str3("' but found '", 13));
		JB_SetRef(JB_str_85, JB_Str3("' on '", 6));
		JB_SetRef(JB_str_84, JB_Str3("Expected suffix '", 17));
		JB_SetRef(JB_str_83, JB_Str3("Internal error.", 15));
		JB_SetRef(JB_str_82, JB_Str3("~/Desktop/Decomp.txt", 20));
		JB_SetRef(JB_str_81, JB_Str3("~/Desktop/Original.txt", 22));
		JB_SetRef(JB_str_80, JB_Str3("abc ", 4));
		JB_SetRef(JB_str_79, JB_Str3("\0\0\0\0\0\0", 6));
		JB_SetRef(JB_str_78, JB_Str3(" loaded successfully.\n", 22));
		JB_SetRef(JB_str_77, JB_Str3("\\n", 2));
		JB_SetRef(JB_str_76, JB_Str3("\\n\\(&#x134;&#xEB;\\C3\\AA\\C6\\81o&#9447;\\) ", 40));
		JB_SetRef(JB_str_75, JB_Str3("\n(ƒ¥√´√™∆Åo‚ìß) ", 16));
		JB_SetRef(JB_str_74, JB_Str3("parent of found ", 16));
		JB_SetRef(JB_str_73, JB_Str3("parent of expected ", 19));
		JB_SetRef(JB_str_72, JB_Str3(" but found ", 11));
		JB_SetRef(JB_str_71, JB_Str3("Expected ", 9));
		JB_SetRef(JB_str_70, JB_Str3("Missing child ", 14));
		JB_SetRef(JB_str_69, JB_Str3("Missing ", 8));
		JB_SetRef(JB_str_68, JB_Str3("~~", 2));
		JB_SetRef(JB_str_67, JB_Str3("::", 2));
		JB_SetRef(JB_str_66, JB_Str3("#!", 2));
		JB_SetRef(JB_str_65, JB_Str3(" #/", 3));
		JB_SetRef(JB_str_64, JB_Str3(" /# ", 4));
		JB_SetRef(JB_str_63, JB_Str3(" @ ", 3));
		JB_SetRef(JB_str_62, JB_Str3("= ", 2));
		JB_SetRef(JB_str_61, JB_Str3("<(`", 3));
		JB_SetRef(JB_str_60, JB_Str3("`)>", 3));
		JB_SetRef(JB_str_59, JB_Str3("{\n", 2));
		JB_SetRef(JB_str_58, JB_Str3(", ", 2));
		JB_SetRef(JB_str_57, JB_Str3("Can‚Äôt find syntax: ", 21));
		JB_SetRef(JB_str_56, JB_Str3("Jeebox: Too many NilObjectErrors. Silencing.", 44));
		JB_SetRef(JB_str_55, JB_Str3("Jeebox: NilObjectError in caller.", 33));
		JB_SetRef(JB_str_54, JB_Str3("$\\{", 3));
		JB_SetRef(JB_str_53, JB_Str3("$\{", 2));
		JB_SetRef(JB_str_52, JB_Str3("\\", 1));
		JB_SetRef(JB_str_51, JB_Str3("\\\n", 2));
		JB_SetRef(JB_str_50, JB_Str3("\\0", 2));
		JB_SetRef(JB_str_49, JB_Str3("\"", 1));
		JB_SetRef(JB_str_48, JB_Str3("\\$", 2));
		JB_SetRef(JB_str_47, JB_Str3("$", 1));
		JB_SetRef(JB_str_46, JB_Str3("z", 1));
		JB_SetRef(JB_str_45, JB_Str3(" b: ", 4));
		JB_SetRef(JB_str_44, JB_Str3("binary escaper different! a: ", 29));
		JB_SetRef(JB_str_43, JB_Str3("they know what they've done", 27));
		JB_SetRef(JB_str_42, JB_Str3("\n", 1));
		JB_SetRef(JB_str_41, JB_Str3("1", 1));
		JB_SetRef(JB_str_40, JB_Str3("(\n", 2));
		JB_SetRef(JB_str_39, JB_Str3("nil,", 4));
		JB_SetRef(JB_str_38, JB_Str3("This class has no saving function for it.", 41));
		JB_SetRef(JB_str_37, JB_Str3("%", 1));
		JB_SetRef(JB_str_36, JB_Str3("  deviance: ", 12));
		JB_SetRef(JB_str_35, JB_Str3("  found: ", 9));
		JB_SetRef(JB_str_34, JB_Str3("expected: ", 10));
		JB_SetRef(JB_str_33, JB_Str3("win", 3));
		JB_SetRef(JB_str_32, JB_Str3("lin", 3));
		JB_SetRef(JB_str_31, JB_Str3("osx", 3));
		JB_SetRef(JB_str_30, JB_Str3("Expected class ", 15));
		...
		JB_SetRef(JB_SyxArg, JB_Fn__StdNew(JB_Msg_Arg__, 0, JB_str_197, JB_str_198));
		JB_SetRef(JB_SyxAcc, JB_Fn__StdNew(JB_Msg_Acc__, 1, JB_str_199, JB_str_200));
		JB_SetRef(JB_SyxAdj, JB_Fn__StdNew(JB_Msg_Adj__, 2, JB_str_201, JB_str_202));
		JB_SetRef(JB_SyxARel, JB_Fn__StdNew(JB_Msg_ARel__, 3, JB_str_203, JB_str_204));
		JB_SetRef(JB_SyxArr, JB_Fn__StdNew(JB_Msg_Arr__, 4, JB_str_205, JB_str_206));
		JB_SetRef(JB_SyxBack, JB_Fn__StdNew(JB_Msg_Back__, 5, JB_str_207, JB_str_208));
		JB_SetRef(JB_SyxSStr, JB_Fn__StdNew(JB_Msg_SStr__, 6, JB_str_209, JB_str_210));
		JB_SetRef(JB_SyxBra, JB_Fn__StdNew(JB_Msg_Bra__, 7, JB_str_211, JB_str_212));
		JB_SetRef(JB_SyxBRel, JB_Fn__StdNew(JB_Msg_BRel__, 8, JB_str_213, JB_str_214));
		JB_SetRef(JB_SyxChar, JB_Fn__StdNew(JB_Msg_Char__, 9, JB_str_215, JB_str_216));
		JB_SetRef(JB_SyxDecl, JB_Fn__StdNew(JB_Msg_Decl__, 10, JB_str_217, JB_str_218));
		JB_SetRef(JB_SyxDot, JB_Fn__StdNew(JB_Msg_Dot__, 11, JB_str_219, JB_str_220));
		JB_SetRef(JB_SyxEmb, JB_Fn__StdNew(JB_Msg_Emb__, 12, JB_str_221, JB_str_222));
		JB_SetRef(JB_SyxERel, JB_Fn__StdNew(JB_Msg_ERel__, 13, JB_str_223, JB_str_224));
		JB_SetRef(JB_SyxFunc, JB_Fn__StdNew(JB_Msg_Func__, 14, JB_str_225, JB_str_226));
		JB_SetRef(JB_SyxItem, JB_Fn__StdNew(JB_Msg_Item__, 15, JB_str_227, JB_str_0));
		JB_SetRef(JB_SyxList, JB_Fn__StdNew(JB_Msg_List__, 16, JB_str_159, JB_str_0));
		JB_SetRef(JB_SyxName, JB_Fn__StdNew(JB_Msg_Name__, 17, JB_str_228, JB_str_0));
		JB_SetRef(JB_SyxNum, JB_Fn__StdNew(JB_Msg_Num__, 18, JB_str_229, JB_str_230));
		JB_SetRef(JB_SyxUnit, JB_Fn__StdNew(JB_Msg_Unit__, 19, JB_str_231, JB_str_0));
		JB_SetRef(JB_SyxOat, JB_Fn__StdNew(JB_Msg_Oat__, 20, JB_str_232, JB_str_233));
		JB_SetRef(JB_SyxOpp, JB_Fn__StdNew(JB_Msg_Opp__, 21, JB_str_234, JB_str_235));
		JB_SetRef(JB_SyxSOpp, JB_Fn__StdNew(JB_Msg_SOpp__, 22, JB_str_236, JB_str_237));
		JB_SetRef(JB_SyxRel, JB_Fn__StdNew(JB_Msg_Rel__, 23, JB_str_238, JB_str_239));
		JB_SetRef(JB_SyxTRel, JB_Fn__StdNew(JB_Msg_TRel__, 24, JB_str_240, JB_str_241));
		JB_SetRef(JB_SyxSDot, JB_Fn__StdNew(JB_Msg_SDot__, 25, JB_str_242, JB_str_243));
		JB_SetRef(JB_SyxSCom, JB_Fn__StdNew(JB_Msg_SCom__, 26, JB_str_244, JB_str_245));
		JB_SetRef(JB_SyxSheb, JB_Fn__StdNew(JB_Msg_Sheb__, 27, JB_str_246, JB_str_247));
		JB_SetRef(JB_SyxStr, JB_Fn__StdNew(JB_Msg_Str__, 28, JB_str_248, JB_str_249));
		JB_SetRef(JB_SyxSThg, JB_Fn__StdNew(JB_Msg_SThg__, 29, JB_str_250, JB_str_251));
		JB_SetRef(JB_SyxThg, JB_Fn__StdNew(JB_Msg_Thg__, 30, JB_str_252, JB_str_253));
		JB_SetRef(JB_SyxTmp, JB_Fn__StdNew(JB_Msg_Tmp__, 31, JB_str_254, JB_str_255));
		JB_SetRef(JB_SyxAna, JB_Fn__StdNew(JB_Msg_Ana__, 32, JB_str_256, JB_str_257));
		JB_SetRef(JB_SyxSCnj, JB_Fn__StdNew(JB_Msg_SCnj__, 33, JB_str_258, JB_str_259));
		JB_SetRef(JB_SyxCnj, JB_Fn__StdNew(JB_Msg_Cnj__, 34, JB_str_260, JB_str_261));
		JB_SetRef(JB_SyxType, JB_Fn__StdNew(JB_Msg_Type__, 35, JB_str_262, JB_str_263));
		JB_SetRef(JB_JSONTest, JB_str_264);
		JB_SetRef(JB_SyxBin, JB_Fn__StdNew(JB_Msg_Bin__, 36, JB_str_265, JB_str_266));
	};
	//// JB_API;
	JB_API__Init_();
	//// Jeebox;
...
bool JB_TestCasting() {
	...
	JB_String* str = JB_Incr(JB_str_79);
	...
	if (JB_Object_FastIsa(yy, JB_AsClass(Message))) {
		if ((!(JB_Str_SyntaxEquals(((Message*)yy)->Name, JB_str_80, false)))) {
			debugger;
		}
	}
	JB_Decr(yy);
...
void JB_Saver_Destructor(ObjectSaver* self) {
	if (self->CantSaveThis) {
		JB_Object_Fail(self->CantSaveThis, JB_str_38);
	}
	JB_Decr(self->Dest);
}
...
void JB_Object_SyntaxExpect(JB_Object* self) {
	JB_Rec_NewItemWithNode(JB_StdErr, nil, JB_str_83);
}
...
void JB_FS_MsgErrorName(FastString* self, JB_String* name) {
	if (JB_Str_Exists(name)) {
		JB_FS_AppendString(self, JB_str_91);
...
void JB_Sav_SaveWrite(Saveable* self, ObjectSaver* Saver) {
	Saver->CantSaveThis = self;
	JB_FS_AppendString(Saver->Dest, JB_str_39);
}



void JB_Str_AppendAsBinary(JB_String* self, FastString* fs) {
	JB_FS_AppendString(fs, JB_str_88);
	JB_FreeIfDead(JB_Str_EncodeB64(self, fs));
	JB_FS_AppendString(fs, JB_str_89);
}
...
Message* JB_Str_ParseAs(JB_String* self, JB_String* name) {
	if ((!JB_Str_Exists(name)) or (JB_Str_SyntaxEquals(name, JB_str_158, true))) {
		return JB_Str_Parse(self, nil);
	} else if (JB_Str_SyntaxEquals(name, JB_str_159, true)) {
		return ({
			Message* _tmp355 = JB_Incr(JB_Str_Parse(self, nil));
			Message* _tmp354 = JB_Incr(JB_Msg_ParseReadable(_tmp355));
			JB_Decr(_tmp355);
			JB_SafeDecr(_tmp354);
			_tmp354;
		});
...
int JB_FI_NextSep(StringFields* self, int Prev) {
	return JB_Str_FindByte(self->Data, Prev, self->Sep);
}
...
Syntax* JB_Fn__StdNew(fpMsgRender msg, int ID, JB_String* name, JB_String* LongName) {
	...
	JB_Array_Append(JB__FuncArray_, result);
	JB_SafeDecr(result);
	return result;
}
...
void JB_Array_SaveWrite(Array* self, ObjectSaver* Saver) {
	FastString* D = Saver->Dest;
	{
		...
		while (_i < JB_Array_Size(self)) {
			JB_Object* v = JB_Array_Value(self, _i);
			if (_first2 != _i) {
				JB_FS_AppendString(D, JB_str_58);
			}
			//start;
...
JB_Object* JB_Dict_Syntax(Dictionary* self, JB_String* Key) {
	return ({
		JB_String* _tmp297 = JB_Incr(JB_Str_FastLower(Key));
		JB_Object* _tmp296 = JB_Incr(JB_Dict_Value(self, _tmp297));
		JB_Decr(_tmp297);
		JB_SafeDecr(_tmp296);
		_tmp296;
	});
...
void JB_Err_GrabLine(JB_Error* self, FastString* fs, bool Usecolor) {
	...
	JB_String* _tmp = JB_Incr(({
		JB_String* _tmp191 = JB_Incr(JB_Str_AccessRange(d, Start, Finish));
		JB_String* _tmp190 = JB_Incr(JB_Str_ReplaceAll(_tmp191, JB_str_15, JB_str_13, false, nil));
		JB_Decr(_tmp191);
		JB_SafeDecr(_tmp190);
		_tmp190;
	}));
...
int JB_Err_LinePos(JB_Error* self, JB_String* data) {
	if (JB_Err_HasPosition(self)) {
		return ({
			JB_String* _tmp188 = JB_Incr(JB_Str_AccessRange(data, 0, self->Position));
			int _tmp187 = JB_Str_LineCount(_tmp188);
			JB_Decr(_tmp188);
			_tmp187;
		});
	}
...
void JB_Err__CantParseNum(Message* Where, JB_String* num, int Pos) {
	...
	JB_String* _tmp1 = JB_Incr(JB_Str_AccessRange(num, 0, 10));
...
void JB_Msg_Arg__(Message* self, FastString* fs) {
	...
	if (P) {
		if (JB_Msg_SyxOppEquals(P, JB_SyxBra, false)) {
			JB_FS_AppendByte(fs, '{');
			JB_Msg_FSListSep(self, fs, JB_str_58);
			JB_FS_AppendByte(fs, '}');
			return;
		}
...
Message* JB_Msg_Copy(Message* self, bool DefaultLayer) {
	if (DefaultLayer) {
		...
		return ({
			JB_MemoryLayer* _tmp236 = JB_Incr(JB_ObjLayer(self));
			Message* _tmp235 = JB_Incr(JB_Msg_LayerCopy(self, _tmp236));
			JB_Decr(_tmp236);
			JB_SafeDecr(_tmp235);
			_tmp235;
		});
...
bool JB_Msg_Expect(Message* self, Syntax* type, JB_String* name) {
	if ((!self)) {
		return true;
	} else if ((self->Type == type) and ((!JB_Str_Exists(name)) or ((JB_Str_SyntaxEquals(self->Name, name, true))))) {
		return true;
	} else if ((!type)) {
...
Message* JB_Msg_LoadNameFromList(Message* self, Message* line) {
	...
	JB_Decr(_tmp);
	JB_SetRef(self->Name, ({
		Message* _tmp252 = JB_Incr(((Message*)JB_Ring_NextSib(func)));
		JB_String* _tmp251 = JB_Incr(JB_Msg_Nyme(_tmp252));
		JB_Decr(_tmp252);
		JB_SafeDecr(_tmp251);
		_tmp251;
	}));
...
JB_String* JB_Msg_Locate(Message* self) {
	JB_String* fname = JB_Incr(JB_str_154);
	if ((!self)) {
		JB_SafeDecr(fname);
		return fname;
	}
	...
	JB_String* rs = JB_Incr(JB_str_154);
...
Message* JB_Msg_NormalCopy(Message* self) {
	Message* Result = JB_Incr(JB_Msg__NewFuncName(self->Type, self->Name));
	{
		Message* v = JB_Incr(((Message*)JB_Tree_First_(self)));
		while (v) {
			Message* _N1 = JB_Incr(((Message*)JB_Ring_NextSib(v)));
...
void JB_Msg_Num__(Message* self, FastString* fs) {
	...
	if ((!ch)) {
		JB_FS_AppendString(fs, self->Name);
	} else if (JB_Str_SyntaxAccess(ch->Name, 0) == '0') {
		JB_FS_AppendString(fs, ch->Name);
		JB_FS_AppendString(fs, self->Name);
	} else {
		JB_FS_AppendString(fs, self->Name);
		JB_FS_AppendString(fs, ch->Name);
...
void JB_Msg_SStr__(Message* self, FastString* fs) {
	if (JB_int_Found(JB_Str_FindStr(self->Name, 0, JB_str_60))) {
		JB_Msg_Str__(self, fs);
	} else {
...
void JB_Msg_Fail(Message* self, JB_String* Error) {
	...
	if (JB_Str_Exists(Error)) {
		...
		FastString* _fs_fs = JB_Incr(JB_FS__New());
		JB_FS_AppendString(_fs_fs, JB_str_94);
		JB_String* _tmp1 = JB_Incr(JB_Msg_FuncName(self));
		JB_FS_AppendString(_fs_fs, _tmp1);
		JB_Decr(_tmp1);
		JB_FS_AppendString(_fs_fs, JB_str_95);
...
void JB_Msg_Test(Message* self, JB_String* new_render, JB_String* name) {
	if ((!JB_Msg_TestSub(self, new_render, name))) {
		FastString* _fs_fs = JB_Incr(JB_FS__New());
		JB_FS_AppendString(_fs_fs, JB_str_160);
...
Syntax* JB_Msg__GetSyx(Message* msg) {
	...
	if ((!_tmp)) {
		FastString* _fs1_fs = JB_Incr(JB_FS__New());
		JB_FS_AppendString(_fs1_fs, JB_str_57);
